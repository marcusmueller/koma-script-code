...
\begin{desclist}
  ...
  \entry{\OptionVName{setup}{list of attributes}}{%
    ...
    \DescRef{\LabelBase.cmd.setuptoc}. Note, if you want to set a
    comma-separated list of attributes, you have to put this list between
    braces.%
  }%
  ...
  \entry{\OptionVName{unset}{list of attributes}}{%
    ...
    \DescRef{\LabelBase.cmd.unsettoc}. Note, if you want to set a
    comma-separated list of attributes, you have to put this list between
    braces.%
  }%
\end{desclist}
