...
% Date of the translated German file: 2019-10-02
...
% TODO: Fix new translation
  ...
  style. With 13 attributes it is almost as high configurable as
  \PValue{tocline}. This style hardly needs, that a still open paragraph is
  finished at the very beginning of the entry of another style and at the end
  of the current table of contents or list of something. So it should never be
  combined with entries or tables of contents or lists of something, that are
  generated without using mechanisms of \Package{tocbasic}.
% :ODOT
...
% :ODOT
  ...
  \entry{\OptionVName{onlastendentry}{code}}{%
    \ChangedAt{v3.27}{\Package{tocbasic}}%
% TODO: Fix new translation
