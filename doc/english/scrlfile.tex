...
\ProvidesFile{scrlfile.tex}[2007/09/18 KOMA-Script guide (chapter: scrlfile)]
...
\begin{Explain}
  ...
  The command \Macro{InputIfFileExists} is used by {\LaTeX} everytime
...
\BeginIndex{Cmd}{AfterPackage*}%
The commands \Macro{AfterClass} und \Macro{AfterPackage} work in the
