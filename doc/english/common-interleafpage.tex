...
\IfThisCommonFirstRun{}{%
  What is described in \autoref{sec:\ThisCommonFileFirstLabelBase.emptypage}
  applies, mutatis mutandis. So if you have alread read and understood
  \autoref{sec:\ThisCommonFileFirstLabelBase.emptypage} you can switch to
...
\Macro{cleardoublepage} to break until the wanted page. Every already defined
\PName{page style} (see \autoref{sec:\ThisCommonLabelBase.pagestyle} from
