...
% Date of the translated German file: 2017-11-13
...
obsolete. It is not longer part of \KOMAScript. It is recommended not to use
that class for new applications. It only available as part
of \cite{package:koma-script-obsolete}.
