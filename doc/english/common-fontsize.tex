...
\IfThisCommonFirstRun{%
  ...
  {this chapter}. \IfThisCommonLabelBase{scrlttr2}{By contrast, the
    \Package{scrletter} package by itself does not offer a font-size selection
...
\IfThisCommonLabelBase{scrlttr2}{%
  ...
  \begin{Example}
    ...
    instead of 12\Unit{pt}. This can be achieved by making a small change to
    the first line:%
    ...
    \begin{figure}
      ...
      \caption[{Example: letter with address, salutation, text, closing phrase,
        ...
        size}]
      {result of a small letter with address, salutation, text, closing phrase,
        postscript, enclosures, distribution list, and a noxiously large font
        (date and folding marks are defaults of DIN-letters): in the left 
        version, the font size has been defined by the optional argument of
        \DescRef{\LabelBase.env.letter}; in the right one, the optional
