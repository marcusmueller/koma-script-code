...
\ProvidesFile{scrlttr2.tex}[2007/08/07 KOMA-Script guide (chapter: scrlttr2)]
...
\end{Declaration}
\BeginIndex{Option}{version}% gross oder klein?
...
%
\EndIndex{}{Kompatibilität}% compatibility?

\subsection{Page Layout Options}
\label{sec:scrlttr2.typeareaOptions}
\BeginIndex{}{Satzspiegel}% page layout?
...
\BeginIndex{}{Papierformat}% paper format?
...
\begin{Explain}
  ...
  for different paper sizes. See \autoref{sec:lcoFile} for more
  information.
...
\EndIndex{}{Satzspiegel}% page layout?
