...
\item[{\PageStyle{empty}%
    \IndexPagestyle[indexmain]{empty}\PageStyleLabel{empty}}] is the page
...
\item[{\PageStyle{headings}%
    \IndexPagestyle[indexmain]{headings}\PageStyleLabel{heading}}] is the page
...
\item[{\PageStyle{myheadings}%
    \IndexPagestyle[indexmain]{myheadings}\PageStyleLabel{myheadings}}] is the
...
\item[{\PageStyle{plain}%
    \IndexPagestyle[indexmain]{plain}\PageStyleLabel{plain}}] is the page
