...
\ProvidesFile{scrlttr2.tex}[2006/06/27 KOMA-Script guide (chapter: scrlttr2)]
...
This pseudo length gives the width of the letter's firstpage footer. The
...
beeing especially usefull when using window envelopes. The address is
...
usefull applications of \Macro{AtBeginLetter} as the following example
may illustrate:
%
\begin{Example}
