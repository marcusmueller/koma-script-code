...
\DescRef{\LabelBase.cmd.AtBeginLetter} to force vertical adjustment.%
\EndIndexGroup
...
is also a symbol for the URL. Note\textnote{Attention!} that you have to load
the \Package{marvosym} or \Package{fontawesome} package in the document
preamble on your own if you activate usage of the corresponding package for
the first time after \Macro{begin}\PParameter{document}.
% :ODOT
