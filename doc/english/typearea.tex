...
similarly selectable. Instead of the \OptionVName{DIV}{Faktor} or
...
\begin{Example}
  ...
  \OptionVName{DIV}{factor} option, exactly that problem of choosing
...
\Macro{KOMAoptions}\PParameter{\OptionVName{DIV}{DIV},%
  \OptionVName{BCOR}{BCOR}} the text block and margins are
...
leave \PName{number of lines} at its default value and adapt it only in special
cases.
