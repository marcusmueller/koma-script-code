...
\ProvidesFile{typearea.tex}[2012/01/31 KOMA-Script guide (chapter: typearea)]
...
\begin{Explain}
  ...
  \item First, subtract the part \Var{BCOR}, required for the binding
    ...
    and divides the rest of the page vertically into \Var{DIV} rows of equal
    height.
...
difference only, if you also use option \Option{pagesize}, that will be
described next.
...
\PName{width} has been interchanged. You should at least pay attention to
...
\begin{table}
  ...
  \begin{desctabular}
    ...
    \pventry{automedia}{Almost the same like \PValue{auto} but if the
