...
\end{Declaration}
The \File{scrsize} prefix for file names of font-size files described \iffree{
in \autoref{sec:maincls-experts.addInfos}}{} on
...
\begin{table}
  \caption[{Style-independent attributes for declaring sectioning
    commands}]{Possible \PName{key}s and \PName{value}s for
