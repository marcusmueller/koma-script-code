...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.parmarkup} for the other
  \KOMAScript{} classes is valid for letters too. So if you have alread read
  and understood \autoref{sec:\ThisCommonFileFirstLabelBase.parmarkup} you can
...
\autoref{tab:\ThisCommonFileFirstLabelBase.parskip}%
\IfThisCommonFirstRun{.%
  \begin{desclist}
  % Umbruchkorrektur
  \vskip-\ht\strutbox
...
%    \caption
  [{Possible values of option \Option{parskip}}]{%
    ...
    the paragraph mark\label{tab:\ThisCommonFileFirstLabelBase.parskip}%
  }%
  {%
...
%  \end{table}%
  \end{desclist}%
}{ at \autopageref{tab:\ThisCommonFileFirstLabelBase.parskip}.}
