...
them only using the commands \Macro{markright}, \Macro{markleft}, and
\Macro{markboth}, that will be described later in this section.
...
Please note\textnote{Attention!}, only loading the package doesn't have
...
Strictly thought command \Macro{pagemark} isn't involved by \TeX's mark
...
\begin{lstcode}
  ...
  \end{document}
\end{lstcode}
  Here command \Macro{MakeMarkcase} has been used to get the same letter case
