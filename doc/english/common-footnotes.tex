...
\IfThisCommonLabelBase{scrlttr2}{%
  ...
  \autopageref{xmpl:\ThisCommonFirstLabelBase.cmd.footnote} onward.%
  \iffalse%
...
\IfThisCommonLabelBase{scrlttr2}{\iffalse}{\csname iftrue\endcsname}%
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.cmd.footref}%
...
\IfThisCommonLabelBase{scrlttr2}{%
  ...
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.cmd.deffootnote}%
