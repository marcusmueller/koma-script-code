...
\IfThisCommonFirstRun{}{%
  ...
  \IfThisCommonLabelBaseOneOf{scrextend,scrlttr2}{ %
    \IfThisCommonLabelBase{scrlttr2}{%
      ...
      itself define any list environments but leaves them to the class
...
\IfThisCommonLabelBase{scrextend}{\iffalse}{\csname iftrue\endcsname}
  ...
  that, depending on the level, a symbol other than a large dot may be used to
...
\end{lstcode}
    ...
    \begin{ShowOutput}
      ...
      \end{labeling}
    \end{ShowOutput}
    As can be seen in this example, a font-changing command can be set
...
\begin{Explain}
  ...
  frequent questions. Therefore, further explanation can be found in the
