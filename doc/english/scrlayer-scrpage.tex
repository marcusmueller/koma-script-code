...
% Date version of the translated file: 2014-10-23
...
simply does not change the content of \Pagestyle{plain.scrheadings}. The
version with star on the other hand uses the obligatory argument
\PName{scrheading's content} in this case also for
