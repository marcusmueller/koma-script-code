...
e.\,g., \DescRef{\LabelBase.cmd.chaptermarkformat} in
...
\end{Declaration}
The \Package{scrlayer-scrpage} package provides two page styles that can be
...
\DescRef{\LabelBase.pagestyle.scrheadings} page styles can be set with these
...
changed using the commands \DescRef{\LabelBase.cmd.setkomafont} and
...
\PageStyle{plain} page style. Available values for \PName{simple switch} can be
