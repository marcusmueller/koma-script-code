...
\translator{Markus Kohm\and Jana Schubert\and Jens Huehne}
...
don't use dirty tricks with \Package{scrpage2}, it should be easy for you to
use \Package{scrlayer-scrpage} instead of that package. Most examples to
