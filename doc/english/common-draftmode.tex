...
\IfThisCommonFirstRun{}{%
  What is written in \autoref{sec:\ThisCommonFileFirstLabelBase.draft}
  applies, mutatis mutandis.  So if you have alread read and understood
  \autoref{sec:\ThisCommonFileFirstLabelBase.draft} you can jump to the end of
  this section on \autopageref{sec:\ThisCommonLabelBase.draft.end}.%
}
