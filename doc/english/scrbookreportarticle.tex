...
% Date of translated german file: 2015-06-14
...
\begin{Explain}%
  ...
  sections not numbered. You should pay attention for this exspecially if you
  redefine \Macro{chaptermark} or \Macro{sectionmark} (see \Macro{ifnumbered}
  on \autopageref{desc:maincls.cmd.ifnumbered}) or you should also redefine
  \Macro{addchapmark} and \Macro{addsecmark} suitable. The star variants
