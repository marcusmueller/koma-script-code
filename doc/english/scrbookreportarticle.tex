...
\textsc{Note: Since version~3.00 the main classes understand command
  ...
  them are documented not yet.  You may find the obsolete and corresponding
  new options at \autoref{tab:maincls-experts.deprecated}.}
...
\begin{Declaration}
  ...
  \OptionValue{cleardoublepage}{plain}\\
  \OptionValue{cleardoublepage}{empty}
\end{Declaration}%
...
\begin{Declaration}
  \Option{headsepline}\\
  \OptionValue{headsepline}{false}\\
  \Option{footsepline}\\
  \OptionValue{footsepline}{false}
\end{Declaration}%
\BeginIndex{Option}{headsepline}%
\BeginIndex{Option}{headsepline~=\PValue{false}}%
\BeginIndex{Option}{footsepline}%
\BeginIndex{Option}{footsepline~=\PValue{false}}%
In order to have a line separating the header from the text body use
the option \Option{headsepline}. The option \OptionValue{headsepline}{false} has
...
the options \Option{footsepline} and \OptionValue{footsepline}{false}, that
...
\EndIndex{Option}{headsepline~=\PValue{false}}%
\EndIndex{Option}{footsepline}%
\EndIndex{Option}{footsepline~=\PValue{false}}%
...
\begin{Declaration}
  ...
  \OptionValue{appendixprefix}{false}
\end{Declaration}%
\BeginIndex{Option}{appendixprefix}%
\BeginIndex{Option}{appendixprefix~=\PValue{false}}%
Sometimes\OnlyAt{\Class{scrbook}\and\Class{scrreprt}} one wishes to
have the chapter titles in simplified form according to
\OptionValue{chapterprefix}{false}. But at the same time, one wishes a title of
...
\EndIndex{Option}{appendixprefix~=\PValue{false}}%
