...
% Date of translated german file: 2015-06-09
...
active, the \PName{then code} will be executed, otherwise the \PName{else
  code}. For example, the command is used at the definition of
\Macro{chapterformat} (see \autopageref{desc:maincls.cmd.chapterformat}).
