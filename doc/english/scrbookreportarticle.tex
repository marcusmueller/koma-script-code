...
\Macro{section*} (see \autoref{sec:\LabelBase.structure},
\DescPageRef{\LabelBase.cmd.section*} and
\DescPageRef{\LabelBase.cmd.addsec}) are thus, in the author's opinion, far
more preferable.
...
\Macro{cleardoubleemptypage} (see \autoref{sec:\LabelBase.emptypage},
...
\end{lstcode}
  ...
  be found at \DescPageRef{\LabelBase.option.numbers}.
...
information about that may be found in \autoref{sec:\LabelBase.toc}. Alternative
...
\end{lstcode}
  ...
  \autoref{sec:\LabelBase.structure} at \DescPageRef{\LabelBase.cmd.addchap*}.
\end{Example}
...
\Option{numbers} in \autoref{sec:\LabelBase.structure},
