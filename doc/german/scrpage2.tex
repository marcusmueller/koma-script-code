...
\ProvidesFile{scrpage2.tex}[2006/06/09 KOMA-Script guide (chapter:scrpage2)]
...
\begin{Declaration}
  \phantomsection\label{desc:scrpage.macro.automark}%
...
\begin{Declaration}
  \phantomsection\label{desc:scrpage.macro.pnumfont}%
  \Macro{headfont}\\
  \Macro{pnumfont}
\end{Declaration}%
...
\begin{Declaration}
\phantomsection\label{desc:scrpage.macro.setheadwidth}%
...
\begin{Declaration}
  \phantomsection\label{desc:scrpage.macro.setheadtopline}%
...
\begin{Declaration}
  \phantomsection\label{desc:scrpage.option.autooneside}%
  \Option{autooneside}
\end{Declaration}%
...
\autopageref{desc:scrpage.macro.automark}.  \EndIndex{Option}{autooneside}
...
\phantomsection\label{desc:scrpage.option.markuppercase}%
...
\phantomsection\label{desc:scrpage.option.nouppercase}%
