...
\Package{scrbase} bietet dafür einen sogenannten Haken
...
\end{lstcode}
  ...
  für die gesamte Familie ausführt und damit auch für andere Wurstpakete
  setzt. Die Verzögerung der Ausführung von \Macro{FamilyOptions} ist hier
  entscheidend. Zum einen werden nur so später geladene Wurstpakete
...
\end{lstcode}
  ...
  eines gültigen Werts für einen booleschen Schalter %der Wert
...
\end{lstcode}
  ...
  verwendet.  Die Bedeutungen der Anweisungen \DescRef{\LabelBase.cmd.ifVTeX}
  und \DescRef{\LabelBase.cmd.ifundefinedorrelax} sowie weitere
  Verzweigungsanweisungen sind 
...
% LocalWords:  Sternvariante Anwenderanweisungen Signalisierung
