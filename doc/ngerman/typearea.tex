...
\begin{table}
  ...
  \begin{desctabular}
    ...
    \pventry{calc}{Satzspiegelberechnung einschließlich Ermittlung eines guten
      \Var{DIV}-Wertes erneut durchführen.\IndexOption{DIV~=\textKValue{calc}}}%
    ...
    \pventry{current}{Satzspiegelberechnung mit dem aktuell gültigen
      \Var{DIV}-Wert erneut durchführen.\IndexOption{DIV~=\textKValue{current}}}%
...
\begin{table}
  ...
  \begin{desctabular}
    \pventry{current}{Satzspiegelberechnung mit dem aktuell gültigen
      \Var{BCOR}-Wert erneut durchführen.\IndexOption{BCOR~=\textKValue{current}}}
  \end{desctabular}
\end{table}
...
\important{\OptionVName{paper}{Breite\textup{:}Höhe}}
beziehungsweise
