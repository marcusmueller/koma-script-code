...
\item[\PValue{tocline}] ist ein flexibler Stil, der in der Voreinstellung für
  ...
  \PValue{section} mit Hilfe dieses Stils, ändern dann jedoch den
  \PName{Initialisierungscode} der Klone so ab, dass sie unterschiedliche
  Voreinstellungen besitzen. 
  ...
  \PValue{onstartsamelevel}, \PValue{pagenumberbox}, \PValue{pagenumberformat}
