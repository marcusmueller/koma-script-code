...
\item[\PValue{tocline}] ist ein flexibler Stil, der in der Voreinstellung für
  ...
  einige Längen-Eigenschaften des Stils.
  \begin{figure}
    \centering
    \resizebox{.8\linewidth}{!}{%
      \begin{tikzpicture}
...
% TODO: Tabelle der Eigenschaften muss noch erstellt werden.
...
\begin{Declaration}
  \Macro{TOCLineLeaderFill}\Parameter{Füllzeichen}
\end{Declaration}
