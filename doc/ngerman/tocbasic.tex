...
\item[\PValue{dottedtocline}] entspricht dem Stil, der von den Standardklassen
  ...
  \begin{figure}
    ...
    \resizebox{.8\linewidth}{!}{%
      \begin{tikzpicture}
        \draw[color=lightgray] (0,2\baselineskip) -- (0,-3\baselineskip);
        \draw[color=lightgray] (\linewidth,2\baselineskip) --
                               (\linewidth,-3\baselineskip);
    ...
    \caption{Illustration der Attribute des Verzeichniseintragsstils
...
\item[\PValue{tocline}] ist ein flexibler Stil, der in der Voreinstellung für
  ...
  gilt für Abbildungs- und Tabellenverzeichnis der Standardklassen.
  % TODO: Eine Abbildung dazu erstellen.  
