...
\DescRef{\LabelBase.cmd.tocbasic@addxcontentsline} verwendet. Diese erhält alle vier Argumente
...
\DescRef{\LabelBase.cmd.tocbasic@addxcontentsline} ist \autoref{sec:tocbasic.internals},
...
\DescPageRef{\LabelBase.cmd.DeclareNewTOC}) sind die Namen der
