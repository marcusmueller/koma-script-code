...
\item[\PValue{toctext}]\ChangedAt{v3.27}{\Package{tocbasic}}%
  ...
  Konfigurierung\important{\PValue{afterpar}, \PValue{entryformat},
    ...
    \PValue{prepagenumber}, \PValue{raggedright}, \PValue{rightindent}} stehen
  neben der Standardeigenschaft \PValue{level} mit 13 weiteren Eigenschaften
  fast so viele Möglichkeiten wie bei \PValue{tocline} zur Verfügung. Dieser
  ...
  Einträgen oder Verzeichnissen kombiniert werden, die an \Package{tocbasic}
...
anstelle von \PValue{level}, zu verwenden. Die zuvor beschriebene
...
\Option{\PName{Schlüssel}+=\PName{Wert}} mit definiert, die dazu dienen, zu
...
Frühere Versionen von \Package{tocbasic} verfügt über einige, wenige Befehle,
