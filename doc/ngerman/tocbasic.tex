...
\ProvidesFile{tocbasic.tex}[2008/07/31 KOMA-Script package tocbasic]
...
\begin{Example}
  ...
  trotzdem nicht, dass Sie diese Eigenschaft setzen, im Gegenteil: wertet eine
  andere Klasse diese Eigenschaft ebenfalls aus, so nutzt Ihr Paket dann eben
  automatisch die Möglichkeiten jener Klasse.
\end{Example}
