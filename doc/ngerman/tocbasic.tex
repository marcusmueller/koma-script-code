...
mit \Macro{CloneTOCEntryStil} zu klonen und dann dessen Initialisierungscode
...
Anweisung um die Stile \PValue{part}, \PValue{chapter}, \PValue{section} oder
\PValue{subsection} zu deklarieren und den Stil \PValue{default} neu als Klon
von \PValue{section} beziehungsweise \PValue{subsection} zu deklarieren.%
