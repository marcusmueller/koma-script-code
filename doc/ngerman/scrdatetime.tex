...
Finnisch (finnish), Norwegisch (norsk), Schwedisch (swedish), Dänisch (danish)
und Polnisch (polish), kann aber auch für andere Sprachen konfiguriert
werden. Dazu gibt man als erstes Argument von \Macro{newdaylanguage} den Namen
der Sprache an und als weitere Parameter die Namen der entsprechenden
Wochentage.
