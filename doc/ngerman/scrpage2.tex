...
\subsection{Vordefinierte Seitenstile}\seclabel{basics.buildIn}
...
\section{Seitenstile selbst gestalten}\seclabel{UI}
%
% 
\subsection{Die Anwenderschnittstelle}\seclabel{UI.user}
% \deftripstyle
...
\subsection{Die Expertenschnittstelle}\seclabel{UI.expert}
...
\subsection{Seitenstile verwalten}\seclabel{UI.cfgFile}
% scrpage.cfg
