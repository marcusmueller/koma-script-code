...
\IfThisCommonFirstRun{%
  ...
  \autoref{sec:\ThisCommonFirstLabelBase.fontOptions} geschrieben wurde. Falls
  Sie also \autoref{sec:\ThisCommonFirstLabelBase.fontOptions} bereits gelesen
  und verstanden haben, können Sie \IfThisCommonLabelBase{scrlttr2}{beim
    Beispiel }{%
