...
\autopageref{tab:scrlayer-scrpage-experts.layersperstyle} kennen lernen. Die
dort angebenen Ebenen werden für ein Seitenstilpaar durch die Tatsache
verdoppelt, dass sie sowohl for \PName{Name} als auch
\PValue{plain.}\PName{Name} definiert werden.%
\EndIndexGroup
