...
\KOMAScript{} auch von Paket \Package{scrextend} bereitgestellt. Dieses Paket
sollte nicht\textnote{Achtung!} mit \KOMAScript-Klassen verwendet werden. Es
ist ausschließlich zur Verwendung mit anderen Klassen gedacht. Der Versuch,
das Paket mit einer \KOMAScript-Klasse zu laden, wird von \Package{scrextend}
...
\autopageref{cha:scrbase} dokumentierten Möglichkeiten bei Verwendung von
