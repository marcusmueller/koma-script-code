...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.options} geschrieben wurde. Falls
  Sie also \autoref{sec:\ThisCommonFileFirstLabelBase.options} bereits gelesen
  und verstanden haben, können Sie auf
  \autopageref{sec:\ThisCommonLabelBase.options.next} mit
  \autopageref{sec:\ThisCommonLabelBase.options.next} fortfahren.%
}
...
\iffalse % Umbruchkorrektur
  ...
  \autopageref{desc:scrbase.cmd.FamilyOptions} zu finden.  \else
  %
