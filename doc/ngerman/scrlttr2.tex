...
\ProvidesFile{scrlttr2.tex}[2009/04/21 KOMA-Script guide (chapter: scrlttr2)]
...
\File{DIN.lco}, \File{DINmtext.lco}, \File{SNleft.lco}, \File{SN.lco} und
\File{NF.lco}\ChangedAt{v3.04}{\Class{scrlttr2}} dienen
dazu, \Class{scrlttr2} an verschiedene Normen\Index{Norm} anzupassen. Sie
...
Kompatibilität zu \Class{scrlettr}, der alten Briefklasse, zu verbessern. Da
