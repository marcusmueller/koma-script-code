...
\Package{scrletter}\textnote{Achtung!} bietet diese Möglichkeit nicht!

Empfohlen\textnote{Empfehlung!} wird nicht nur für \Package{scrletter},
sondern auch für die Klasse \Class{scrlttr2}, eine \File{lco}-Datei immer über
\Macro{LoadLetterOption} oder
\Macro{LoadLetterOptions}\ChangedAt{v3.14}{\Class{scrlttr2}} zu
