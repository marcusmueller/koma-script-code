...
auch in diesen Fällen ebenfalls ohne Endung übergeben. Während
\Macro{LoadLetterOption} nur genau ein Argument \Parameter{Name} erwartet und
somit nur genau eine \File{lco}-Datei laden kann, versteht
