...
Nummernzeile und der eigentlich Überschrift außerdem
...
\begin{longtable}[l]{llp{\dimexpr\linewidth-6\tabcolsep-17em}}
  ...
  \endlastfoot
    ...
    \PValue{tocindent} & \PName{Länge}  & Der horizontale Einzug des zum
                                          ...
                                          erzeugt wird.\\ 
    \PValue{tocnumlevel} & \PName{Ganzzahl} & 
...
\Macro{chapter} und \Macro{section} verändert. Sie sollten daher ebenfalls
nicht unmittelbar über die hier erklärten Anweisungen verändert werden.
