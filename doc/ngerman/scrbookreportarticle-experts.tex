...
\begin{table}
  ...
  \begin{tabularx}{\linewidth}{llX}
    ...
    & Es wird bestimmt, ob auf die erste Zeile nach der Überschrift der
      aktuelle Absatzeinzug angewendet wird. Mit dem \PName{Schalter}
      ...
      deaktiviert werden. Voreingestellt ist \PValue{false}.\\
    \PValue{afterskip}%
    \ChangedAt{v3.26}{\Class{scrbook}\and \Class{scrreprt}}%
    & \PName{Länge}
...
\begin{table}
  ...
  \begin{tabularx}{\linewidth}{llX}
    ...
    \PValue{beforeskip}
    & \PName{Länge}
    & Der Betrag gibt den vertikalen Abstand vor der Überschrift an.\\
    \PValue{font}
    & \PName{Befehle}
    & Die Schrifteinstellungen, die zusätzlich zum Element
      \DescRef{maincls.fontelement.disposition} bei der Ausgabe der
