...
Pakete würden dadurch automatisch Ereiterungen von \KOMAScript{} deaktiviert
und Gliederungsbefehle in die Hände jener Pakete gelegt. Gleichzeitig müssten
aber zum Erhalt der Kompatibilität mit anderen Paketen zusätzliche Maßnahmen
ergriffen werden.
...
beeinträchtigt werden könnte. Die Bedeutung der Parameter der ist der
Anleitung zum \LaTeX-Kern \cite{latex:source2e} zu entnehmen.
Als\ChangedAt[01/2019]{v3.27}{\Class{scrbook}\and \Class{scrreprt}\and
...
\begin{Explain}
  ...
  \end{Declaration}
  Bis\ChangedAt[01/2019]{v3.27}{\Class{scrbook}\and \Class{scrreprt}\and
  ...
  \DescRef{\LabelBase.cmd.SecDef}. Seit \KOMAScript~v3.27 gelten sie jedoch
  als veraltet.
