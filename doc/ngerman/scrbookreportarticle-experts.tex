...
darüber nicht definiert werden. Die Spezialüberschriften \Macro{addpart},
\Macro{addchap} und \Macro{addsec} werden hingegen automatisch und mittelbar
zusammen mit \Macro{part}, \Macro{chapter} und \Macro{section} verändert. Sie
sollten daher ebenfalls nicht unmittelbar über die hier erklärten Anweisungen
verändert werden.
