...
und \Macro{chapter} können darüber nicht definiert werden. Die
...
\Macro{chapter} und \Macro{section} verändert. Sie sollten daher
...
Gliederungsbefehls. Zum einen wird im Fehlerfall, also wenn eine Anwesiung bei
...
deren Werte lediglich die Einstellung des ersten Gliederungsbefehls aus der
\PName{Namensliste} ist. Für alle weiteren Gliederungsbefehle werden die Werte
von \PValue{level} und \PValue{toclevel} um den Wert von
...
\Length{@tempskipa} aber noch vor Einfügen des Abstandes angewendet. Es damit
also noch möglichen, den Abstand über Änderung von \Length{@tempskipa} zu
verändert.
...
% LocalWords:  Klassenoptionen Gliederungsbefehlen
