...
\Macro{aliaskomafont} definiert wurde und daher auch mit
...
der Befehle innerhalb von \DescRef{maincls.cmd.part} entsprechend der Einstellungen von
...
weitere \PName{Anweisungen} für die Ausführung nach der Präambel und am Ende
des Literaturverzeichnisses, so werden die mit
\DescRef{maincls.cmd.AfterBibliographyPreamble} festgelegten
