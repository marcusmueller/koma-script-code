...
\begin{desclist}
  ...
  \feentry{pagefoot}{%
    ...
    \Variable{nextfoot}\IndexVariable{nextfoot} definierten Seitenfuß verwendet
    oder wenn das Paket \Package{scrlayer-scrpage}\iffree{ oder das veraltete
      \Package{scrpage2}}{} geladen ist (\autoref{cha:scrlayer-scrpage},
