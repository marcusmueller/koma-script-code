...
\IfThisCommonLabelBase{maincls}{%
  ...
  \DescPageRef{maincls.cmd.setchapterpreamble}) zu verwenden.
  \iffalse Dies ist jedoch nicht zwingend.\fi% Umbruchkorrektur
  \par%
}{}%
...
%
  \IfThisCommonLabelBase{maincls}{%
    \vskip -1\ht\strutbox plus .75\strutbox% Code + Beispiel + Erklärungsende
