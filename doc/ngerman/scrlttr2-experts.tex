...
\KOMAScript~3.15\ChangedAt[2014/11]{v3.15}{\Package{scrletter}} und
ausschließlich in der Beta-Version und zu Testzwecken das Paket
\Package{scrletter}\IndexPackage{scrletter}, das zusammen mit einer der
...
Unterschiede gibt es jedoch. Dieser werden ebenfalls in diesem Kapitel genannt.
}{}
...
\label{sec:scrltt2-experts.pagestyleatscrletter}
...
erklärt, dass \File{lco}-Dateien direkt über \Macro{documentclass} laden
...
empfohlen wird, \File{lco}-Dateien über \Macro{LeadLetterOption} oder
