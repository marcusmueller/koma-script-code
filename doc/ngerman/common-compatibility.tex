...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.compatibilityOptions} geschrieben
  ...
  also \autoref{sec:\ThisCommonFileFirstLabelBase.compatibilityOptions}
  bereits gelesen und verstanden haben, können Sie auf
  \autopageref{sec:\ThisCommonLabelBase.compatibilityOptions.end} fortfahren.%
}
