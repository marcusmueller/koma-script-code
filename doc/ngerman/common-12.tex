...
(siehe \autoref{tab:\csname label@base\endcsname.fontelements},
\autopageref{tab:\csname label@base\endcsname.fontelements}) geändert
...
\autopageref{tab:\csname label@base\endcsname.fontelements}%
\fi) geändert
