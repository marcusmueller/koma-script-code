...
\begin{desclist}
  ...
  \pventry{standardclasses}{%
    ...
    Setzt die Schrifteinstellung für die einzelnen Standard-Gliederungsebenen
    zurück und verwendet Überschriften in den Größen der
    Standardklassen. Für Kapitelüberschriften wird bei \Class{scrbook} und
    \Class{scrreprt} \OptionValue{headings}{twolinechapter}
    gesetzt.%
  }%
