...
Zu\ChangedAt{v3.20}{\Class{scrbook}\and \Class{scrreprt}\and
  \Class{scrartcl}}\textnote{Achtung!} ist, dass die an \Macro{setcapwidth}
übergebene \PName{Breite} wie bei \Macro{setlength} zum Zeitpunkt der
Zuweisung ausgewertet wird. Will man hingegen, dass \PName{Breite} erst bei
der Verwendung ausgewertet wird, dann sollte man stattdessen
