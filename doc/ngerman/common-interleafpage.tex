...
%
  ...
  Aus dieser Erklärung ergibt sich auch, dass Vakatseiten normalerweise nur im
  doppelseitigen Satz existieren.%
  \fi%
%
  \iffalse % Umbruchkorrektur
...
linken Seite\IfThisCommonLabelBase{scrlttr2}{ und }{, }% Umbruchoptimierung
\Macro{cleardoubleevenpage} zur nächsten rechten Seite. Eine gegebenenfalls
einzufügenden Vakatseite wird mit dem über Option
