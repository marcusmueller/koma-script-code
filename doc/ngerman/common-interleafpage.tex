...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.emptypage} geschrieben
  wurde. Falls Sie also \autoref{sec:\ThisCommonFileFirstLabelBase.emptypage}
...
der Anweisung \Macro{cleardoublepage} eingefügt wird, um bis zur gewünschten
Seite zu umbrechen. Als \PName{Seitenstil} sind dabei alle bereits definierten
Seitenstile (siehe \autoref{sec:\ThisCommonLabelBase.pagestyle} ab
...
\IfThisCommonLabelBase{maincls}{%
  ...
  \autoref{sec:maincls.structure}, \autopageref{desc:maincls.option.open}
  erklärten Option
  \DescRef{maincls.option.open}\IndexOption{open}\important{\Option{open}}
  abhängig und entspricht je nach Einstellung einer der in den vorherigen
...
\IfThisCommonLabelBase{scrlttr2}{\iffalse}{\csname iftrue\endcsname}
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.cmd.cleardoublepage}%
