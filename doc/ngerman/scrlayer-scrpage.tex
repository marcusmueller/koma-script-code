...
auf \Package{scrlayer} eine mit \Package{scrpage2} weitgehend kompatible und
gleichzeitig stark erweiterte Anwender-Schnittstelle bereitstellt. Wer bereits
mit \Package{scrpage2} vertraut ist und dort keine unsauberen Rückgriffe auf
interne Anweisungen getätigt hat, kann daher in der Regel \Package{scrpage2}
recht einfach durch \Package{scrlayer-scrpage} ersetzen. Das gilt mit der
genannten Einschränkung auch für die meisten Beispiele in \LaTeX-Büchern oder
im Internet.
...
\Package{scrlayer-scrpage} empfohlen. \iffree{Bei Problemen damit kann auch auf
\Package{scrpage2} zurückgegriffen werden.}{\ignorespaces} Natürlich kann
...
kann.\iffree{}{ Bei Verwendung von
...
\end{lstcode}
\end{Example}%
\iffree{}{Der Code dieses Beispiels funktioniert ebenfalls auch mit dem
  veralteten Paket
  \Package{scrpage2}\IndexPackage{scrpage2}\important{\Package{scrpage2}},
  allerdings nur, solange eine \KOMAScript-Klasse wie \Class{scrartcl}
  verwendet wird.}%
...
Die für
\Package{scrpage2}\IndexPackage{scrpage2}\important{\Package{scrpage2}}
dokumentierten Paketoptionen \Option{komastyle} und \Option{standardstyle}
existieren in \Package{scrlayer-scrpage} nur aus Gründen der
Kompatibilität. Sie werden jedoch auf Option \Option{pagestyleset} abgebildet,
gelten als überholt und sollten nicht mehr verwendet werden.\iffree{}{ Bei
  Verwendung des veralteten Pakets \Package{scrpage2}\IndexPackage{scrpage2}
  sind sie hingegen die einzige Möglichkeit zwischen den beiden
  unterschiedlichen Voreinstellungen umzuschalten, da dort Option
  \Option{pagestyleset} nicht existiert.}%
