...
% Copyright (c) Markus Kohm, 2014-2016
%
...
\DescPageRef{scrlayer-scrpage.cmd.setkomafont}) bis hin zum
...
\autoref{sec:maincls.structure}, \DescPageRef{maincls.option.numbers} und
...
\DescPageRef{scrlayer-scrpage.cmd.setkomafont}), sondern alle zusammen
...
\DescPageRef{scrlayer-scrpage.cmd.setkomafont}). In der Voreinstellung
