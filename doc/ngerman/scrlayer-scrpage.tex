...
\autoref{sec:scrlayer-scrpage.textmarkup},
\autopageref{desc:scrlayer-scrpage.cmd.setkomafont}), sondern alle zusammen
über das Element \FontElement{pagefoot}. Vor diesem wird außerdem noch das
Element \FontElement{pageheadfoot} angewandt. Die Voreinstellungen für diese
beiden Elemente sind \autoref{tab:scrlayer-scrpage.fontelements},
\autopageref{tab:scrlayer-scrpage.fontelements} zu entnehmen.%
\EndIndex{FontElement}{pageheadfoot}%
