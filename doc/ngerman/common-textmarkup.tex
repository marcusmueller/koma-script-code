...
\IfThisCommonLabelBaseOneOf{scrjura,scrlayer-notecolumn}{}{%
  ...
  \IfThisCommonLabelBase{scrlayer-scrpage}{ %
    Die angegebenen Voreinstellungen gelten nur, wenn das jeweilige
    Element beim Laden von \Package{scrlayer-scrpage} nicht bereits definiert
    ist. Beispielsweise definieren die \KOMAScript-Klassen
    \DescRef{maincls.fontelement.pageheadfoot} und es gilt dann die
    von \Package{scrlayer-scrpage} vorgefundene Einstellung.%
  }{ %
    Die Voreinstellungen sind den jeweiligen Abschnitten zu entnehmen.%
  }%
}%

\IfThisCommonLabelBase{scrlttr2}{% Umbruchvarianten
...
\IfThisCommonLabelBase{maincls}{\iftrue}{\csname iffalse\endcsname}
  \begin{Example}
    ...
    Schriftart wie für
    \DescRef{\ThisCommonLabelBase.fontelement.descriptionlabel} verwenden. Das
