...
%  \par%
%  Vor dem Missbrauch der Schrifteinstellungen
%  wird dennoch dringend gewarnt (siehe \autoref{sec:maincls-experts.experts},
%  \DescPageRef{maincls-experts.cmd.addtokomafontrelaxlist})!%
  ...
  in die Schrifteinstellungen der Elemente beliebige Anweisungen
