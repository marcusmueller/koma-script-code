...
\end{lstcode}
  ...
  \begin{desclist}
    ...
    \feentry{author}{%
      ...
      \DescPageRef{maincls.cmd.author})}%
    ...
    \feentry{chapter}{%
      ...
      \DescPageRef{maincls.cmd.chapter})}%
    ...
    \feentry{dedication}{%
      ...
      \autoref{sec:maincls.titlepage},
      \DescPageRef{maincls.cmd.dedication})}%
    \feentry{descriptionlabel}{%
      ...
      \DescPageRef{maincls.env.description})}%
    \feentry{dictum}{%
    ...
    \feentry{subject}{%
      ...
      \autoref{sec:maincls.titlepage},
      \DescPageRef{maincls.cmd.subject})}%
    ...
    \feentry{titlehead}{%
      ...
      \DescRef{\ThisCommonLabelBase.cmd.maketitle} (siehe
      \autoref{sec:maincls.titlepage},
      \DescPageRef{maincls.cmd.titlehead})}%
  \end{desclist}
\else
      ...
      \IfThisCommonLabelBase{scrlayer-scrpage}{%
        \begin{desclist}
          ...
          \feentry{pagefoot}{%
            ...
            \DescPageRef{scrlayer-scrpage.fontelement.pagefoot}). Das
            Element wird nach \Macro{normalfont}\IndexCmd{normalfont} und nach
            dem Element
          ...
          \feentry{pagehead}{%
            ...
            definierten Seitenstils (siehe
            \autoref{sec:scrlayer-scrpage.predefined.pagestyles},
            \DescPageRef{scrlayer-scrpage.fontelement.pagehead}). Das
            Element wird nach \Macro{normalfont}\IndexCmd{normalfont} und nach
          ...
          \feentry{pagenumber}{%
            ...
            \autoref{sec:scrlayer-scrpage.predefined.pagestyles},
            \DescPageRef{scrlayer-scrpage.fontelement.pagenumber}). Bei
