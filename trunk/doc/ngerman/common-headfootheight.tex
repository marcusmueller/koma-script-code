...
\DescPageRef{typearea.option.footheight}) und zur Berücksichtigung des
Fußes bei der Berechnung des Satzspiegels (siehe Option
\DescRef{typearea.option.footinclude} in demselben Abschnitt,
\DescPageRef{typearea.option.footinclude}) sehr gut zum Setzen der Werte
für \Package{scrlayer} verwendet werden können und auch das gewünschte
Ergebnis liefern.
