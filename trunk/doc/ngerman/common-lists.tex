...
\IfThisCommonLabelBase{scrextend}{\iffalse}{\csname iftrue\endcsname}
  ...
  \IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
    \begin{Example}
      \phantomsection\label{xmpl:\ThisCommonLabelBase.env.itemize}%
...
\end{lstcode}
  ...
  \IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
    \begin{Example}
      \phantomsection\label{xmpl:\ThisCommonLabelBase.env.enumerate}%
  ...
  \IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
    \begin{Example}
      \phantomsection\label{xmpl:\ThisCommonLabelBase.env.description}%
...
festgelegt werden. Die Schriftart\Index{Schrift>Art}%
...
\IfThisCommonFirstRun{\iftrue}{\par\csname iffalse\endcsname}
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.env.labeling}%
    \IfThisCommonLabelBase{scrextend}{%
...
\IfThisCommonLabelBase{scrextend}{\iffalse}{\csname iftrue\endcsname}
  ...
  \IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
    \begin{Example}
      \phantomsection\label{xmpl:\ThisCommonLabelBase.env.verse}%
...
\end{lstcode}
  ...
  \else
    ...
    \IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
      \begin{Example}
        \phantomsection\label{xmpl:\ThisCommonLabelBase.env.quote}%
...
\IfThisCommonFirstRun{\iftrue}{\csname iffalse\endcsname}
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.env.addmargin}%
