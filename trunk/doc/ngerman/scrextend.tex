...
\IndexOption{titlepage~=\PValue{false}}\Index{Titel>Kopf} verwendet wird, ist
im Makro \Macro{titlepagestyle} festgelegt. In der Voreinstellung ist das der
Seitenstil \DescRef{maincls.pagestyle.plain}\IndexPagestyle{plain}. Dieser
