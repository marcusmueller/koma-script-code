...
\DescPageRef{scrlttr2-experts.cmd.newplength} behandelt. Ebenso ist das Setzen
von Pseudolängen eher dem fortgeschrittenen Anwender vorbehalten. Also wird
auch dies im Abschnitt für Experten ab
\DescPageRef{scrlttr2-experts.cmd.setplength} erklärt.  Eine Liste aller in
\Class{scrlttr2} definierten Pseudolängen findet sich in
