...
Briefes mit \Macro{label}\Parameter{Labelname} ein Label setzen und mit
\Macro{ref}\Parameter{Labelname} dann an beliebiger Stelle im Dokument darauf
verweisen. Innerhalb des Briefes selbst erhält man dasselbe Ergebnis auch ganz
ohne Label mit \Macro{thisletter}. 
...
setzen. Dadurch ist es möglich, mit \Macro{letterlastpage} jederzeit innerhalb
...
die Ausgabe allerdings erst nach mehreren \LaTeX-Läufen -- meist zwei oder drei
-- gültig. Achten Sie gegebenenfalls auf entsprechende \emph{Rerun}-Meldungen
in der Terminal-Ausgabe oder der \File{log}-Datei.%
...
%  LocalWords:  Versandart Zentrierung Dokumenttitel Serienbriefen
