...
\end{Example}
Natürlich haben die Anweisung \Macro{pagestyle} und \Macro{thispagestyle}
...
\item[{\PageStyle{headings}}] ist der Seitenstil für automatische
  ...
  \autoref{sec:scrlttr2.firstpage},
  \DescPageRef{scrlttr2.variable.fromname} und
  \DescPageRef{scrlttr2.variable.subject}). Wo genau diese Marken und die
