...
\ProvidesFile{scrlttr2.tex}[2008/08/12 KOMA-Script guide (chapter: scrlttr2)]
...
\begin{Example}
  ...
  »Peter Mustermann« ginge das einfach mit:
\begin{lstcode}
...
\begin{lstcode}
  \setkomavar{fromname}[Absender]{Peter Mustermann}
\end{lstcode}
...
Anschriftfeldes.  Die Option versteht die Standardwerte für einfache Schalter,
die in \autoref{tab:truefalseswitch}, \autopageref{tab:truefalseswitch}
angegeben sind. Voreingestellt ist \PValue{true}. Name und Adresse des
Empfängers, die im Anschriftfeld gesetzt werden, werden über das Argument der
...
Im Anschriftfeld wird zusätzlich in der Voreinstellung noch die
Rücksendeadresse gesetzt.  Mit der Option \Option{backaddress} kann gewählt
werden, ob und in welcher Form die
...
den Fuß\ChangedAt{v3.00}{\Class{scrlttr2}} ist zusätzlich auch noch das Element
\FontElement{pagefoot} zuständig, das nach \FontElement{pageheadfoot} zur
