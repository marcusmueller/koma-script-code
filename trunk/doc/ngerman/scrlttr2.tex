...
Durchwahlnummern. \KOMAScript{} setzt automatisch nur nicht leere
Felder. Statt einer komplett leeren Geschäftszeile werden gegebenenfalls
Bezeichnung und Inhalt der Variablen \DescRef{\LabelBase.variable.date}
ausgegeben.%
\else%
