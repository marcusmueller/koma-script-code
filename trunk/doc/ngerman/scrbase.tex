...
wenn die einfache Expansion der \PName{Zeichenfolge} eine gültige Länge mit
...
ausgeführt, \iffree{}{\pagebreak}% Umbruchkorrektur
...
Anweisung. In der Dokument \Macro{if@atdocument} in der Dokumentpräambel
\Macro{iffalse}, nach \Macro{begin}\PParameter{document} entspricht
\Macro{if@atdocument} hingegen \Macro{iftrue}.  Klassen- und Paketautoren
