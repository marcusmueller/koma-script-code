...
ausgeführt. Anschließend wird erneut die fordere Zeichenfolge vom Rest
...
\begin{Example}
  ...
  \DescRef{maincls-experts.cmd.ProvideSectionCommand} angegebe \PName{Name}
...
\end{lstcode}
  ...
  \Macro{setcounter}\PParameter{sectionZaehler}\PParameter{} ausgeführt. Wir
...
\PName{Spezifiktor} bestimmten Haken gespeichert wurden, führt diese Anweisung
...
\end{Declaration}
Wie\ChangedAt[2019/01]{v3.27}{\Package{scrbase}} aus den vorangegangen
