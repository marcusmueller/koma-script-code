...
werden. In\important[i]{\Option{headtopline}\\ \Option{headsepline}\\
  \Option{footsepline}\\ \Option{footbotline}} diesem Fall richtigen sich die
Längen und Dicken je nach Linie nach den Angaben der Option
\Option{headtopline}\IndexOption{headtopline},
\Option{headsepline}\IndexOption{headsepline},
\Option{footsepline}\IndexOption{footsepline} oder
...
%    [l]
    \begin{tabular}{ll}
      ...
      \PName{Name}\PValue{.head.odd} & den Kopf von rechten Seiten im
      doppelseitigen Layout\\
      \PName{Name}\PValue{.head.even} & den Kopf von linken Seiten im
      doppelseitigen Layout\\
      \PName{Name}\PValue{.head.oneside} & den Kopf von Seiten im
      einseitigen Layout\\
      \PName{Name}\PValue{.head.below} & die Linie unter dem Kopf\\
      \PName{Name}\PValue{.foot.above.line} & die Linie über dem Fuß\\
      \PName{Name}\PValue{.foot.odd} & den Fuß von rechten Seiten im
      doppelseitigen Layout\\
      \PName{Name}\PValue{.foot.even} & den Fuß von linken Seiten im
      doppelseitigen Layout\\
      \PName{Name}\PValue{.foot.oneside} & den Fuß von Seiten im
      einseitigen Layout\\
