...
\PageStyle{scrheadings}, dient dabei quasi auch als Name des Seitenstil-Paars.
...
\hyperref[cha:scrlayer]{\Package{scrlayer}}\IndexCmd{scrlayer}. Die dabei für
einen Seitenstil \PName{Name} definierten Ebenen sind in
