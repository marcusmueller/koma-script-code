...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFirstLabelBase.textmarkup} geschrieben
  wurde. Falls Sie also \autoref{sec:\ThisCommonFirstLabelBase.textmarkup}
...
\IfThisCommonLabelBase{scrlayer-scrpage}{\iffalse}{\csname iftrue\endcsname}%
  ...
  \ifthiscommonfirst
    \begin{Example}
      \phantomsection
      \label{xmpl:\ThisCommonFirstLabelBase.cmd.textsubscript}%
...
\end{lstcode}
  ...
  \else%
    ...
    \autopageref{xmpl:\ThisCommonFirstLabelBase.cmd.textsubscript}.%
  \fi%
  \EndIndexGroup%
\fi
