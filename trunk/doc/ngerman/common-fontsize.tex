...
\IfThisCommonFirstRun{%
  ...
  verstanden haben, können Sie \IfThisCommonLabelBase{scrlttr2}{beim
    Beispiel}{letzten Absatz}
  am Ende dieses Abschnitts auf
  \autopageref{sec:\ThisCommonLabelBase.fontOptions.end} fortfahren.%
  \IfThisCommonLabelBase{scrlttr2}{ Wenn Sie dagegen \Package{scrletter}
    verwenden, können Sie auch direkt zu
    \autoref{sec:scrlttr2.fontOptions.next} auf
    \autopageref{sec:scrlttr2.fontOptions.next} springen.}{}%
}
...
Es wird darauf\textnote{Achtung!} hingewiesen, dass bei Verwendung nach dem
Laden der Klasse die Auf"|teilung zwischen Satzspiegel und Rändern nicht
automatisch neu berechnet wird (siehe
