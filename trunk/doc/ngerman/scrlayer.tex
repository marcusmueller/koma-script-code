...
\KOMAProvidesFile{scrlayer.tex}[$Date$
                                KOMA-Script guide 
                                (chapter:scrlayer)]
...
Hierarchie. Mit Hilfe der Anweisung \Macro{DeclareSetionNumberDepth} kann
...
\begin{desclist}
  \desccaption{%
    Optionen und gleichnamige Haken für Ebenen-Seitenstile (in der
    Reihenfolge ihrer Abarbeitung)\label{tab:scrlayer.pagestyle.hooks}%
  }{%
  ...
  \entry{\KOption{oninit}\PName{Code}}{%
    ...
    Ausgabe der Ebenen für den Seitenstil initialisiert
    wird. Beachten\textnote{Achtung!} Sie, dass dies für jede Seite zweimal
  ...
  \entry{\KOption{ontwoside}\PName{Code}}{%
    ...
    initialisiert wird. Beachten\textnote{Achtung!} Sie, dass dies für jede
  ...
  \entry{\KOption{onoddpage}\PName{Code}}{%
    ...
    initialisiert wird. Beachten\textnote{Achtung!} Sie, dass dies für jede
    Seite zweimal geschieht: einmal für Hintergrund-Ebenen und einmal für
    Vordergrund-Ebenen. Beachten\textnote{Achtung!} Sie außerdem, dass im
  ...
  \entry{\KOption{onfloatpage}\PName{Code}}{%
    ...
    initialisiert wird. Beachten\textnote{Achtung!} Sie, dass dies für jede
    Seite zweimal geschieht: einmal für Hintergrund-Ebenen und einmal für
    Vordergrund-Ebenen. Beachten\textnote{Achtung!} Sie außerdem, dass
  ...
  \entry{\KOption{onnonfloatpage}\PName{Code}}{%
    ...
    die keine Gleitumgebungsseite ist. Beachten\textnote{Achtung!} Sie, dass
    dies für jede Seite zweimal geschieht: einmal für Hintergrund-Ebenen und
    einmal für Vordergrund-Ebenen. Beachten\textnote{Achtung!} Sie außerdem,
  ...
  \entry{\KOption{onbackground}\PName{Code}}{%
    ...
    wird. Beachten\textnote{Achtung!} Sie, dass dies auf jeder Seite genau
    einmal der Fall ist.%
  }%
...
Seitenstils vergleichbar mit dem Hinzufügen einer Ebene bzw. von Haken-Code zu
allen Ebenen-Seitenstile. Der eine entscheidende Unterschied ist: Befehle, die
sich auf die Ebenen eines Seitenstils beziehen, beispielsweise
\Macro{ForEachLayerOfPageStyle}, \Macro{AddLayersToPageStyleBeforeLayer} oder
...
separierten \PName{Ebenenliste} angegeben. Die Anweisungen
\Macro{AddLayersToPageStyle} und \Macro{AddLayersAtEndOfPageStyle} fügen die
Ebenen am Ende der Ebenenliste des Seitenstils ein. Logisch liegen die neu
...
Der Versuch, Ebenen von einem Seitenstil zu entfernen, die gar nicht Teil des
Seitenstils sind, wird ignoriert, führt also nicht zu einer
Fehlermeldung. Dagegen ist der Versuch, Ebenen zu einem Seitenstil, der kein
Ebenen-Seitenstil ist und auch kein Alias-Seitenstil, der zu einem
Ebenen-Seitenstil führt, hinzuzufügen oder von einem solchen zu entfernen ein
...
\ref{sec:scrlayer.enduserinterfaces} für weitere Informationen zu diesem
Thema.%
...
Endanwender-Schnittstellen ab \autoref{cha:scrlayer.scrpage}.
