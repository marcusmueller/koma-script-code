...
existiert. Ist der Name hingegen bereits für eine andere Ebene verwendet, so
...
Ebenen-Seitenstil\textnote{Ebenen-Seitenstil}\Index{Seitenstil>Ebenen}. Ein
...
Alias-Seitenstil\textnote{Alias-Seitenstil}\Index{Seitenstil>Alias} oder
...
Die \PName{Optionenliste} ist eine mit Komma separierte Liste Optionen der Form
\texttt{\PName{Schlüssel}=\PName{Code}}. Diese Optionen können
