...
\PName{Dann-Teil} ausgeführt, anderenfalls der \PName{Sonst-Teil}. Verwendet
wird dies beispielsweise in der Definition von \Macro{chapterformat} (siehe
\autopageref{desc:maincls.cmd.chapterformat}).
...
\begin{lstcode}
  ...
  \newcommand*{\chapterformat}{%
    \mbox{\chapappifchapterprefix{\nobreakspace}\thechapter
      \autodot\IfChapterUsesPrefixLine{}{\enskip}}}
...
\Macro{sectionformat}. Bitte\textnote{Achtung!} beachten Sie, dass bei der
