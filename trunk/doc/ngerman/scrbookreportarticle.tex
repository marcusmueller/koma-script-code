...
\autoref{sec:maincls.titlepage}, \DescPageRef{maincls.option.titlepage})
...
\DescPageRef{maincls.cmd.setkomafont}) verändert werden.  Zuständig
...
\autoref{tab:maincls.fontelements},
\autopageref{tab:maincls.fontelements}).  Dabei wird die Schriftart für
