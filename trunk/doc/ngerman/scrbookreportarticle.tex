...
\Class{scrartcl}\OnlyAt{\Class{scrartcl}} für \DescRef{\LabelBase.cmd.part} nicht
...
\IndexFontElement{chapterprefix}\ChangedAt{v2.96a}{\Class{scrbook}\and
...
\Option{listof} in \autoref{sec:\LabelBase.floats},
...
\PValue{small} für die Option \DescRef{\LabelBase.option.headings}\IndexOption{headings} abhängig
...
\begin{Explain}
  ...
  der Zähler \Counter{secnumdepth} auf einen Wert gesetzt, mit dem die
  Nummerierung von Kapiteln beziehungsweise Abschnitten abgeschaltet
...
sichergestellt, dass Überschriften mit \DescRef{\LabelBase.cmd.addchap} den Kolumnentitel nicht
...
\DescRef{\LabelBase.option.numbers} in
\autoref{sec:\LabelBase.structure},
...
im Anhang wird durch die Optionen \DescRef{\LabelBase.option.chapterprefix} und
