...
\item[{\PageStyle{empty}%
    \BeginIndex[indexmain]{Pagestyle}{empty}\PageStyleLabel{empty}}] ist der
...
\item[{\PageStyle{headings}%
    \BeginIndex[indexmain]{Pagestyle}{headings}\PageStyleLabel{headings}}] ist
...
\item[{\PageStyle{myheadings}%
    \BeginIndex[indexmain]{Pagestyle}{myheadings}\PageStyleLabel{myheadings}}]
...
\item[{\PageStyle{plain}%
    \BeginIndex[indexmain]{Pagestyle}{plain}\PageStyleLabel{plain}}]
