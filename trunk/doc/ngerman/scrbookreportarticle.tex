...
\leavevmode\phantomsection\nobreak
\LabelOptionValue{toc}{graduated}\nobreak
...
\DescRef{\LabelBase-experts-nonfree.cmd.thepage}\IndexCmd{thepage}, sondern
das dafür vorgesehene
\DescRef{\LabelBase-experts-nonfree.cmd.pagemark}\IndexCmd{pagemark} verwendet
wird.%
\EndIndexGroup
%
\EndIndexGroup
...
\fi
  ...
  \important[i]{\DescRef{\LabelBase.cmd.frontmatter}\\
...
entsprechen, aus.
Für den Anhang stehen als Alternativen zu
\OptionValueRef{\LabelBase}{appendixprefix}{true} und
\OptionValueRef{\LabelBase}{appendixprefix}{false}
die Optionen \OptionValue{headings}{twolineappendix} und
\OptionValue{headings}{onelineappendix} zur Verfügung.
\iffalse
Für den Anhang
stehen \OptionValue{headings}{twolineappendix} und
\OptionValue{headings}{onelineappendix} zur Verfügung, die den Optionen
\OptionValueRef{\LabelBase}{appendixprefix}{true} und
\OptionValueRef{\LabelBase}{appendixprefix}{false}
entsprechen (siehe ebenfalls oben).
\fi
Diese existieren natürlich nicht
bei \Class{scrartcl}%
...
\important[i]{\begin{tabular}[t]{@{}l@{}} \Option{headings=}\\
    \quad\PValue{standardclasses}\end{tabular}} passt zum Einen die
...
\begin{desclist}
  ...
  \pventry{openany}{%
    ...
    Satz wie bei \OptionValue{headings}{openright} auf die nächste rechte
...
\OptionVName{head}{Kolumnentitel}\important[i]{\Option{head}\\
  \Option{tocentry}\\
...
\Package{nameref}\IndexPackage{nameref}\important[i]{\Package{nameref}\\
  \Package{titleref}\\
...
\important[i]{\DescRef{\LabelBase.cmd.part}, \DescRef{\LabelBase.cmd.chapter},
...
\end{lstcode}
  ...
  unterdrückt, ist nun auch der Verlag zufrieden gestellt.
\end{Example}%
\fi
...
\begin{Explain}
  ...
  Pakets \hyperref[cha:scrlayer-scrpage]{\Package{scrlayer-scrpage}}\IndexPackage{scrlayer-scrpage} ändert sich
...
\leavevmode\phantomsection\nobreak%
\LabelOptionValue{captions}{tableheading}\nobreak%
...
Parameter oder außerhalb einer Gleitumgebung auch komplett ohne optionalem
