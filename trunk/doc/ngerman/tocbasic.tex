...
Dateierweiterungen geführt werden kann\iffree{ und wie automatisch Anweisungen
  beim Hinzufügen von Dateierweiterungen zu dieser Liste ausgeführt werden
  können}{}. Des Weiteren haben Sie eine Anweisung kennen gelernt, mit der man
...
\PName{Dateierweiterung} spezifierte Verzeichnis aufzunehmen. Dabei ist
...
aufgehoben werden. Die \PName{Liste von Eigenschaften} ist dabei eine durch
...
\item[\PValue{leveldown}] bedeutet, dass das Verzeichnis nicht mit der
  ...
  \IndexOption{listof~=\PValue{leveldown}} für alle Dateierweiterungen des
...
\Macro{DefineTOCEntryNumberOption}}{\Macro{DefineTOCEntry\dots Options}}.
...
Haken ausgewertet werden kann. Die Erklärungen der Haken finden Sie im
Anschluss.
...
verwendet, sollten die Anweisungen für die Haken trotzdem aufgerufen
werden.%
\EndIndexGroup
...
nicht verwendet, sollten die beiden Anweisungen für die Haken trotzdem
aufgerufen werden, soweit sie definiert sind. Die Anweisungen können auch
undefiniert sein. Für einen entsprechenden Test siehe
...
Eigenschaft \Option{onstartsamelevel} im zugehörigen, internen Makro\linebreak
...
beiden einen Umbruch, wenn sie im vertikalen Modus ausgeführt werden.
%\end{sloppypar}

Entwickler, die eigene Stile kompatibel mit \PValue{tocline} erstellen
...
normalerweise den Typ~1 und 2. Abbildungen dürfen also Tabellen überholen und
umgekehrt.
\begin{lstcode}
...
zurecht kommt, das benötigt wird, um den ersten Buchstaben des Wert von
...
%  LocalWords:  Eintragsebenen Platzierungsoptionen
