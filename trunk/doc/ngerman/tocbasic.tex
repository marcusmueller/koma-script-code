...
\begin{desclist}
  ...
  \entry{\OptionVName{counterwithin}{\LaTeX-Zähler}}{%
    ...
    werden. Die\ChangedAt{v3.35}{\Package{tocbasic}} Abhängigkeit wird
    allerdings außerhalb des Hauptteils eines Dokuments (siehe
    ...
    \DescPageRef{maincls.cmd.frontmatter}) ignoriert. Ist \Macro{chapter}
    definiert und \OptionValue{counterwithin}{chapter} oder anderenfalls
    \OptionValue{counterwithout}{section} so wird die Abhängigkeit außerdem
    ignoriert, wenn \PName{\LaTeX-Zähler} bei der Ausgabe kleiner als eins
    ist.%
  }%
  \entry{\Option{float}}{%
