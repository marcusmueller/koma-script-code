...
beziehungsweise zum \LaTeX-Kern definierten \Macro{addcontentsline}. Der
...
\item[\PValue{numberline}] \ChangedAt{v3.12}{\Package{tocbasic}}%
  ...
  einer (leeren) \Macro{numberline}-Anweisung verstehen werden. Das führt in
...
will. Siehe dazu \autoref{sec:scrbase.languageSupport}.
...
\Macro{KOMAoptions} (siehe \autoref{sec:typearea.options}) bekannt ist. Diese
