...
\item[\PValue{undottedtocline}] entspricht dem Stil, der von den
  ...
  \end{figure}
\end{description}
Eine Erklärung zu den Eigenschaften der von \Package{tocbasic} definieren
...
\begin{desclist}
  ...
  \entry{\KOption{indent}\PName{Länge}}{%
    ...
    (siehe \autoref{fig:tocbasic.dottedtocline} und
  ...
  \entry{\KOption{level}\PName{Integer}}{%
    ...
    Dieses Attribut ist für alle Stile zwingend und wird bei der
  ...
  \entry{\KOption{numwidth}\PName{Länge}}{%
    % TODO: Muss noch erklärt werden.
    Muss noch erklärt werden
    (siehe \autoref{fig:tocbasic.dottedtocline} bis
    \autoref{fig:tocbasic.undottedtocline}).%
  }%
  ...
  \entry{\KOption{pagenumberbox}\PName{Code}}{%
    % TODO: Muss noch erklärt werden.
    Muss noch für Stil \PValue{tocline} erklärt werden.%
  }%
  ...
  \entry{\KOption{raggedpagenumber}\PName{Code}}{%
    % TODO: Muss noch erklärt werden.
    Muss noch für Stil \PValue{tocline} erklärt werden.%
  }%
\end{desclist}%
