...
\DescPageRef{tocbasic.cmd.tocbasic@extend@babel}.
%
\EndIndexGroup
...
\DescPageRef{tocbasic.cmd.setuptoc} zu finden.%
\EndIndexGroup
...
\DescPageRef{tocbasic.cmd.tocbasic@starttoc} zu entnehmen.
...
\DescPageRef{tocbasic.cmd.tocbasic@addxcontentsline} zu entnehmen.

Ein Vorteil der Verwendung von \Macro{addxcontentsline} gegenüber
\Macro{addcontentsline} ist zum einen, dass die Eigenschaft
\PValue{numberline} (siehe \DescPageRef{tocbasic.cmd.setuptoc}) beachtet
...
\item[\PValue{onecolumn}] \leavevmode\ChangedAt{v3.01}{\Package{tocbasic}}%
  ...
  \DescPageRef{tocbasic.cmd.AtAddToTocList}) für alle Verzeichnisse mit
...
\DescPageRef{tocbasic.cmd.DeclareNewTOC}) sind die Namen der
...
\begin{desclist}
  ...
  \entry{\OptionVName{breakafternumber}{Schalter}}{%
    ...
    \DescPageRef{tocbasic.cmd.setuptoc}), wie dies bei den
  ...
  \entry{\OptionVName{linefill}{Code}}{%
    ...
    \DescPageRef{tocbasic.cmd.TOCLineLeaderFill}) initialisiert.
  ...
  \entry{\OptionVName{onstartlowerlevel}{Code}}{%
    ...
    \DescPageRef{tocbasic.cmd.LastTOCLevelWasHigher}), was normalerweise
  ...
  \entry{\OptionVName{onstartsamelevel}{Code}}{%
    ...
    \DescPageRef{tocbasic.cmd.LastTOCLevelWasSame}), was normalerweise
    dazu führt, dass ein Umbruch vor dem Eintrag begünstigt wird.%
  }%
...
\DescPageRef{tocbasic.cmd.addxcontentsline}) erzeugt. Dabei schreibt
...
\DescPageRef{tocbasic.cmd.setuptoc}) kann dies unterdrückt werden. Für
...
\DescPageRef{maincls.cmd.captionabove}) können dann verwendet werden.
...
%  LocalWords:  Verzeichniseintrags Säumniswert
