...
Neben den normalen Optionen der Form \Option{\PName{Schlüssel}=\PName{Wert}}
werden von allen fünf \Macro{DefineTOCEntry\dots Option}-Anweisungen
automatisch Optionen der Form
...
werden außerdem Optionen der Form \Option{\PName{Schlüssel}+=\PName{Wert}}
mit definiert, die dazu dienen, zu dem in
