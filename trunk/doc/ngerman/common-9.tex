...
\IfNotCommon{scrextend}{Fußnoten\ChangedAt{v3.00}{\Class{scrbook}\and
    \Class{scrreprt}\and \Class{scrartcl}\and \Class{scrlttr2}} werden
}%
...
\IfNotCommon{scrextend}{\autoref{tab:\csname
    label@base\endcsname.fontelements}, \autopageref{tab:\csname
    label@base\endcsname.fontelements}}%
\IfCommon{scrextend}{\autoref{tab:maincls.fontelements},
...
\begin{Example}
  \phantomsection
  \label{desc:\csname label@base\endcsname.cmd.deffootnote.example}%
