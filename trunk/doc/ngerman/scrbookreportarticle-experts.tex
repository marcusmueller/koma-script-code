...
\begin{Declaration}
  \Macro{chapterlineswithprefixformat}%
    \PName{Ebene}\PName{Nummer}\PName{Text}\\
...
Anweisungen werden von Überschriften des Stils \PValue{chapter} in
Abhängigkeit von Option \Option{chapterprefix}\IndexOption{chapterprefix}%
...
%  LocalWords:  spartanisch Kapitelstil
