...
der Befehle innerhalb von \Macro{part} zuvor entsprechend der Einstellungen
von \Macro{DeclareSectionCommand}\IndexCmd{DeclareSectionCommand} gesetzt.
...
%  LocalWords:  Inhaltsverzeichniseintrags Abstandsanweisungen
