...
Zusätzlich zu den hier dokumentierten Anweisungen, müssen die
\KOMAScript-Klassen auch
\Macro{@ssect}\IndexCmd{@ssect}\important{\Macro{@ssect}} und
\Macro{@xsect}\IndexCmd{@xsect}\important{\Macro{@xsect}} umdefinieren. Auch
hier sind Inkompatibilitäten mit Paketen, die an derselben Stelle ansetzen,
