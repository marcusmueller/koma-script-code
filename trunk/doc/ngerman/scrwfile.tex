...
\end{lstcode}
  ...
  \phantomsection\label{example:scrwfile.BeforeStartingTOC}
\begin{lstcode}
...
\end{lstcode}
  ...
  Anweisung \Macro{BeforeStartingTOC} ist in \autoref{sec:tocbasic.toc} auf
  \autopageref{desc:tocbasic.cmd.BeforeStartingTOC} zu finden.
\end{Example}
%
\EndIndexGroup
