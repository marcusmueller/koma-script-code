...
sogenannten \emph{Color Stack} notwendig. Dieser Aufwand wurde bisher für ein
Paket, das lediglich als Machbarkeitsstudie konzipiert ist, dadurch umgangen,
dass Farbumschaltungen nur generell über die Schriftattribute des Elements
\FontElement{notecolumn.\PName{Name der Notizspalte}} möglich sind.
...
Verarbeitung der Kopfzeile eine Seite eingelesen wird. Das hat vor allem dann
Auswirkungen, wenn dies geschieht, während eine Umgebung wie
\Environment{verbatim} aktiv ist. In diesem Fall sind dann während des
Einlesens der Hilfsdatei die \Macro{catcode}-Einstellungen dieser Umgebung
aktiv. Dies führt zwangsläufig zu Fehler in der Verarbeitung und Ausgabe.%
\EndIndexGroup
