...
Die Voreinstellungen für alle neue deklarierten Notizspalten entsprechen im
...
ist \autoref{sec:scrlayer.layers} zu entnehmen.
%
\begin{Example}
...
\end{lstcode}
  ...
  verwendet. Somit können Notizspalten auf allen Seiten ausgegeben werden.
...
\begin{lstcode}
  ...
  Kongress statt, wurde aber vom damalige Spaßvesier
...
eingelesen und am Ende der Seite die Notizen für die jeweilige Seite
ausgegeben.
...
Seite\textnote{Seitenumbruch}\Index{Seitenumbruch}, so wird sie ganz oder
...
\begin{lstcode}
    ...
    entsprechendem Umfeld frappierend. Auf der 
...
solche erzwungene Ausgabe\textnote{Ausgabe>erzwungene} ist beispielsweise das
...
Notizen anderer Notizspalten ausgegeben, jedoch nur so lange, wie dies zu
