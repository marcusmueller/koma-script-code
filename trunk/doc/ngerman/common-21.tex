...
relativ komplexe Fälle abdecken.\iffree{}{ Das veraltete Paket
  \Package{scrpage2}\IndexPackage{scrpage2}\important{\Package{scrpage2}}
  kennt ebenfalls \Macro{automark}, jedoch nicht \Macro{automark*}. Dies ist
  bei den nachfolgenden Beispielen gegebenenfalls zu berücksichtigen.}%
%
\begin{Example}
