...
\OptionVName{DIV}{Faktor}.  Selbstverständlich können Sie diese Option auch
...
Verwenden Sie in diesem Fall an Stelle von \OptionVName{DIV}{Faktor} oder
...
\begin{Example}
  In dem bei der Option \OptionVName{DIV}{Faktor} aufgeführten
...
\Macro{KOMAoptions}\PParameter{\OptionVName{DIV}{DIV},%
  \OptionVName{BCOR}{BCOR}} Ränder und Satzspiegel zunächst
...
beispielsweise per Option \Option{BCOR}\IndexOption{BCOR} eingestellte
Bindekorrektur erhalten bleiben, sollte man den symbolischen Wert
...
beschriebene Option
\Option{pagesize}\IndexOption{pagesize}\important{\Option{pagesize}} nicht
deaktiviert sein.
