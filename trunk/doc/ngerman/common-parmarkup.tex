...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.parmarkup} geschrieben wurde.
  Falls Sie also \autoref{sec:\ThisCommonFileFirstLabelBase.parmarkup} bereits
...
%    \caption
  [{Mögliche Werte für Option \Option{parskip}}]{%
    ...
    von Absätzen\label{tab:\ThisCommonFileFirstLabelBase.parskip}%
  }%
  {%
...
%  \end{table}%
  \end{desclist}%
}{ auf \autopageref{tab:\ThisCommonFileFirstLabelBase.parskip}.}
