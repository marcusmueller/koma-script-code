...
\IfThisCommonLabelBase{maincls}{%
  ...
  \IfThisCommonLabelBase{scrlttr2}{%
    ...
    \iftrue % Umbruchoptimierung
      ...
      \autopageref{sec:ThisCommonFirstLabel.footnotes} finden.%
    \fi%
  }{%
...
\IfThisCommonLabelBase{scrlttr2}{%
  ...
  \autopageref{xmpl:\ThisCommonFirstLabelBase.cmd.footnote} zu entnehmen.%
  \iffalse%
}{\csname iftrue\endcsname}%
  \begin{Example}
    \phantomsection\label{xmpl:\ThisCommonLabelBase.cmd.footnote}%
...
\IfThisCommonLabelBase{scrlttr2}{\iffalse}{\csname iftrue\endcsname}%
  ...
  \begin{Example}
    \phantomsection
    \label{xmpl:\ThisCommonLabelBase.cmd.footref}%
...
\IfThisCommonLabelBase{scrlttr2}{\par%
  ...
  \autopageref{xmpl:\ThisCommonFirstLabelBase.cmd.footref}.%
}{}%
%
\EndIndexGroup
...
\BeginIndexGroup
\BeginIndex{FontElement}{footnote}\FontElementLabel{footnote}%
\BeginIndex{FontElement}{footnotelabel}\FontElementLabel{footnotelabel}%
Auf%
\IfThisCommonLabelBase{maincls}{%
...
\FontElementLabel{footnotereference}%
...
\IfThisCommonLabelBase{scrlttr2}{\iffalse}{\csname iftrue\endcsname}%
  \begin{Example}
    \phantomsection
    \label{xmpl:\ThisCommonLabelBase.cmd.deffootnote}%
...
\end{lstcode}
    ...
    \DescRef{\ThisCommonLabelBase.cmd.addtokomafont} (siehe
    \autoref{sec:\ThisCommonLabelBase.textmarkup},
    \DescPageRef{\ThisCommonLabelBase.setkomafont}) zu lösen:
\begin{lstcode}
...
\IfThisCommonLabelBase{scrlttr2}{%
  ...
  \autopageref{xmpl:\ThisCommonFirstLabelBase.cmd.deffootnote}.%
}{}%
%
\EndIndexGroup
\EndIndexGroup
...
\BeginIndexGroup
\BeginIndex{FontElement}{footnoterule}\FontElementLabel{footnoterule}%
Die Farbe%
\IfThisCommonLabelBase{maincls}{%
