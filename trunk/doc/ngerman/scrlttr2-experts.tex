...
\PageStyle{headings} der Inhalt der Variablen \DescRef{scrlttr2.variable.nexthead} und
\DescRef{scrlttr2.variable.nextfoot} den Kopf und Fuß der Seite bestimmt. Da dieser Seitenstil
...
\begin{Declaration}
  \DescRef{scrlttr2.cmd.LoadLetterOption}\Parameter{Name}
  \DescRef{scrlttr2.cmd.LoadLetterOptions}\Parameter{Liste von Namen}
\end{Declaration}
