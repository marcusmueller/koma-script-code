...
\end{lstcode}
  ...
  Sie dann \Option{SNmmarg} anstelle von \Option{SN}.
\end{Example}
%
\EndIndexGroup
...
ihrer Stelle Bezeichnung und Inhalt der Variablen
\DescRef{scrlttr2.variable.date} ausgegeben. Informationen, wie Variablen zur
Geschäftszeile hinzugefügt oder entfernt werden, sind in
