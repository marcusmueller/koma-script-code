...
Die Pseudolänge \PLength{firstheadhpos} gibt bei einem positiven Wert den
Abstand des Briefkopfes von der linken Papierkante an. Ist der Wert sogar
größer oder gleich der Breite des Papiers,
...
Die Pseudolänge \PLength{firstfoothpos} gibt bei einem positiven Wert den
Abstand des Briefbogenfußes von der linken Papierkante an. Ist der Wert sogar
größer oder gleich der Breite des Papiers,
