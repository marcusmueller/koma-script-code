...
\PName{Stil} \PValue{frame}. Nach unten offene Felder werden nicht
komplett umrahmt, sondern unten offen mit kleinen Pfeilen
...
markiert. Bei nach unten offenen Feldern entfallen die unteren
...
\Class{scrlttr2} oder \Package{scrletter} geeignet ist. Dies ist ein vor
