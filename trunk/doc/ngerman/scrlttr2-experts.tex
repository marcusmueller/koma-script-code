...
\Package{scrlayer-scrpage}\iffree{ oder dem veralteten \Package{scrpage2}}{}
auch für \Macro{markleft}\IndexCmd{markleft} (siehe
...
alter Rechtschreibung, Englisch (unter anderem \PValue{english} ohne Angabe, ob
...
Schwedisch\ChangedAt{v3.08}{\Class{scrlttr2}} und
Polnisch\ChangedAt{v3.12}{\Class{scrlttr2}}.
