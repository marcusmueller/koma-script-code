...
Es gilt sinngem‰ﬂ, was in \autoref{sec:maincls.draft} geschrieben wurde.
\else %------------------------------------------------------- nur maincls -
...
graphics in their owen draft mode. Instead they output a framed box of the
appropriate size containing only the graphic's filename (see
...
\OptionValue{draft}{false} option no such boxes are shown. Such overly ling
