...
\ProvidesFile{typearea.tex}[2008/09/25 KOMA-Script guide (chapter: typearea)]
...
\KOption{paper}\PName{size}, \OptionValue{twoside}{semi},
\OptionValue{twocolumn}{false}, \KOption{headheight}\PName{height},
...
\begin{Declaration}
  \Option{headinclude}\\
  \OptionValue{headinclude}{false}\\
  \Option{footinclude}\\
  \OptionValue{footinclude}{false}
\end{Declaration}%
\BeginIndex{Option}{headinclude}%
\BeginIndex{Option}{headinclude~=false}%
\BeginIndex{Option}{footinclude}%
\BeginIndex{Option}{footinclude~=false}%
...
\OptionValue{headinclude}{false} and \OptionValue{footinclude}{false} cause them to be
counted as border. If you are unsure about the correct setting,
re-read above explanations. Default is usually
\OptionValue{headinclude}{false} and \OptionValue{footinclude}{false}., but this can
...
\EndIndex{Option}{headinclude~=false}%
\EndIndex{Option}{footinclude}%
\EndIndex{Option}{footinclude~=false}%

\begin{Declaration}
  \Option{mpinclude}\\
  \OptionValue{mpinclude}{false}
\end{Declaration}
\BeginIndex{Option}{mpinclude}%
\BeginIndex{Option}{mpinclude~=false}%
...
area.  Using option \OptionValue{mpinclude}{false}, the default setting, then the normal
...
\EndIndex{Option}{mpinclude~=false}%
