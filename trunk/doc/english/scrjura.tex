...
option off in this way. Please use the \Environment{contract} environment
directly.%
\EndIndexGroup
...
of contracts, meaning inside of the environment \Environment{contract}.
...
\DescPageRef{\LabelBase.cmd.setkomafont}). Inside the \Environment{contract}
...
the running head. On the other hand we do not want
