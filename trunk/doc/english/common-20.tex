...
The package \Package{scrlayer} brings as a new length \Length{footheight}
...
properly. Also it will warn and give you additional information about the
changes and proper settings you may use yourself. The automatic changes will
become valid immediately after their need has been detected. But they won't be
removed automatically ever, even if a content with lower height would be
detected.%
