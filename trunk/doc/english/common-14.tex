...
% Date of the translated German file: 2012/05/29
...
The third choice,\ChangedAt{v3.12}{\Class{scrbook}\and
    \Class{scrreprt}\and \Class{scrartcl}\and \Package{scrextend}}
\OptionValue{titlepage}{firstiscover}%
...
\Option{titlepage} would cancel this setting. The margins\important{%
  ...
  \Macro{coverrightmargin}} of the cover page are given by
\Macro{covertopmargin}\IndexCmd[indexmain]{covertopmargin},
\Macro{coverbottommargin}\IndexCmd[indexmain]{coverbottommargin},
\Macro{coverleftmargin}\IndexCmd[indexmain]{coverleftmargin} und
\Macro{coverrightmargin}\IndexCmd[indexmain]{coverrightmargin}. The defaults
of these depend on the lengths \Length{topmargin}\IndexLength{topmargin} and
