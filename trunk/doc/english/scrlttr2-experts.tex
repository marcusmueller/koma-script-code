...
additional package \Package{scrletter}\IndexPackage{scrletter} exists that can
be used with one of the \KOMAScript{} classes \Class{scrartcl},
\Class{scrreprt}, or \Class{scrbook}. It provides all the features of
\Class{scrlttr2} for those classes. But there are some small differences,
...
In \autoref{sec:scrlttr2.pagestyle} you have been told, that page style
...
\Package{scrlayer-scrpage}\IndexPackage{scrlayer-scrpage}. Because of this,
...
In\ChangedAt{v3.15}{\Package{scrletter}} \autoref{sec:scrlttr2.lcoFile} you
have been told, that \File{lco}-files can be loaded via
\Macro{documentclass}. Package \Package{scrletter} does not support this.
