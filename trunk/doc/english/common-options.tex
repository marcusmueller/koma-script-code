...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFileFirstLabelBase.options} is generally
  applicable. So if you have alread read and understood
  \autoref{sec:\ThisCommonFileFirstLabelBase.options} you can switch to
  \autopageref{sec:\ThisCommonLabelBase.options.end}.}
