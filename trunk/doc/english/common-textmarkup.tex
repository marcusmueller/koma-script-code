...
\IfThisCommonFirstRun{}{%
  What is described in \autoref{sec:\ThisCommonFileFirstLabelBase.textmarkup}
  applies, mutatis mutandis. So if you have alread read and understood
  \autoref{sec:\ThisCommonFileFirstLabelBase.textmarkup.next} you can switch
...
\end{lstcode}
    ...
    \else % maybe some time I've made an English book
      ...
      \autopageref{desc:experts.macroargs}.%
    \fi
  \else
...
Names\IfThisCommonLabelBase{scrlayer-scrpage}{, defaults,}{} and meanings of
...
\IfThisCommonLabelBase{scrextend}{ %
  However only the listed elements for the document title,
  dicta, footnotes, and the \DescRef{maincls.env.labeling} environment are
...
\IfThisCommonLabelBase{scrlayer-scrpage}{}{ %
  The default values are shown in the
...
\end{lstcode}
  ...
  \begin{desclist}
    \desccaption{%
      ...
      \Macro{addtokomafont}\label{tab:maincls.fontelements}%
    }{%
    ...
    \feentry{captionlabel}{label of a table or figure caption; used according
      to the element \FontElement{caption} (see \autoref{sec:maincls.floats},
    ...
    \feentry{chapterentrypagenumber}{%
      ...
      \FontElement{chapterentry} (see \autoref{sec:maincls.toc},
      \autopageref{desc:maincls.cmd.tableofcontents})}%
    \feentry{chapterprefix}{%
      chapter number line at setting
      \OptionValueRef{maincls.option.chapterprefix}{true} or
      \OptionValueRef{maincls.option.appendixprefix}{true} (see
      \autoref{sec:maincls.structure},
    ...
    \feentry{labelingseparator}{separator, i.\,e., the optional argument of
      ...
      according to the element \FontElement{labelinglabel} (see
      \autoref{sec:maincls.lists}, \autopageref{desc:maincls.env.labeling})}%
    ...
    \feentry{partentrypagenumber}{%
      ...
      \FontElement{partentry} (see \autoref{sec:maincls.toc},
      \autopageref{desc:maincls.cmd.tableofcontents})}%
    ...
    \feentry{sectionentrypagenumber}{%
      ...
      \FontElement{sectionentry} (only available in \Class{scrartcl, see
        \autoref{sec:maincls.toc},
        \autopageref{desc:maincls.cmd.tableofcontents}})}%
    ...
    \feentry{title}{main title of the document, i.\,e., the argument of
      ...
      \autoref{sec:maincls.titlepage} from
...
\end{lstcode}
      ...
      \OptionValueRef{scrextend.option.extendedfeature}{title} (see
    ...
    \IfThisCommonLabelBase{scrlttr2}{%
      ...
      \begin{desclist}
        ...
        \feentry{labelingseparator}{%
          ...
          according to the element \FontElement{labelinglabel} %
          (see \autoref{sec:scrlttr2.lists},
          \autopageref{desc:scrlttr2.env.labeling})}%
        \feentry{pagefoot}{%
          used after element \FontElement{pageheadfoot} for the page foot,
          that has been defined with variable
        ...
        \feentry{toaddress}{%
          variation of the element \FontElement{addressee} for setting the
          addressee address (less the name) in the address field %
          (\autoref{sec:scrlttr2.firstpage},
          \autopageref{desc:scrlttr2.variable.toaddress})}%
        \feentry{toname}{%
          variation of the element \FontElement{addressee} for the name (only)
      ...
      \IfThisCommonLabelBase{scrlayer-scrpage}{%
        \begin{desclist}
          ...
          \feentry{footbotline}{%
            ...
            \FontElement{pagefoot}\FontElement{pagefoot}. It is recommended to
            use this element for colour changes only.\par
            Default: \emph{empty}%
          }%
          \feentry{footsepline}{%
          ...
          \feentry{headsepline}{%
            ...
            \Macro{normalfont}\IndexCmd{normalfont} and the fonts of elements
            \FontElement{pageheadfoot}\IndexFontElement{pageheadfoot} and
            \FontElement{pagehead}\FontElement{pagehead}. It is recommended to
            use this element for colour changes only.\par
            Default: \emph{empty}%
          }%
          \feentry{headtopline}{%
