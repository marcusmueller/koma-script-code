...
\section{Basic Functionality}\seclabel{basics}
...
\subsection{Predefined Page Styles}\seclabel{basics.buildIn}
...
\section{Defining Own Page Styles}\seclabel{UI}
%
% 
\subsection{The Interface for Beginners}\seclabel{UI.user}
% \deftripstyle
...
\subsection{The Interface for Experts}\seclabel{UI.expert}
...
\subsection{Managing Page Styles}\seclabel{UI.cfgFile}
% scrpage.cfg
