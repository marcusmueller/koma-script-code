...
\begin{desclist}
  ...
  \ventry{addresseeimage}{%
    ...
    \OptionValueRef{\LabelBase}{addrfield}{backgroundimage} or the Port-Pay\'e addressee of
    option \OptionValueRef{\LabelBase}{addrfield}{image} %
...
\DescPageRef{\LabelBase.cmd.setkomafont}) with element
...
\OptionValue{priority}{B} (see \autoref{tab:\LabelBase.priority}) together with
...
\autoref{tab:\LabelBase.AddresseeElements} and may be changed using commands \DescRef{\LabelBase.cmd.setkomafont} und \DescRef{\LabelBase.cmd.addtokomafont} (siehe
\autoref{sec:\LabelBase.textmarkup},
\DescPageRef{\LabelBase.cmd.setkomafont}).%
...
%  \caption
  ...
  \begin{tabular}[t]{lll}
    ...
    \DescRef{\LabelBase.variable.date}     & \Macro{datename}     & date \\
    \bottomrule
  \end{tabular}
  \end{captionbeside}
...
\DescRef{\LabelBase.cmd.opening}\IndexCmd{opening} for the first page of the letter.
