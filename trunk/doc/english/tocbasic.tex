...
% TODO: Fix new translation
  ...
  additional attributes in addition to the default \PValue{level} attribute it
...
If\ChangedAt{v3.20}{\Package{tocbasic}} use
...
% TODO: Fix new translation
Beside the usual options of the form \Option{\PName{key}=\PName{value}} the
five \Macro{DefineTOCEntry\dots Option} commands automatically define options
of the form \Option{\PName{key}:=\PName{entry level}}. These copy the value of
