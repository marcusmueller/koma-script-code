...
\end{lstcode}
  ...
  define the contents of the right mark. For information about some 
...
\end{lstcode}
  ...
  first mark placed on the corresponding page. For more details, see the
  additional explanation of \DescRef{maincls-experts.cmd.rightmark} in
  \autoref{sec:maincls-experts.addInfos},
