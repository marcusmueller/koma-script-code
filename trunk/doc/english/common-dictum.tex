...
\IfThisCommonLabelBase{maincls}{}{% Umbruchkorrekturtext
  At this poit, the \Package{ragged2e}\important{\Package{ragged2e}}%
  \IndexPackage{ragged2e} package should be noted, with which you can produce
  unjustified text with hyphenation (see \cite{package:ragged2e}).%
}%
\fi
%
\EndIndexGroup
