...
\ProvidesFile{common-15.tex}[2012/02/08 KOMA-Script guide (common paragraphs)]
...
\IfCommon{scrextend}{%
  ...
  \Package{setchapterpreamble} and \Macro{setpartpreamble}. You should read
...
Sometimes you may find a dictum, a kind smart slogan or excerpt often ragged
...
The command \Macro{dictum} inserts such an dictum.
...
vertical object to command \Macro{dictumrule}:
