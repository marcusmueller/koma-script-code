...
considered. If the macro isn't defined, \Package{scrlayer} searches for
...
page is a page, that may itself flow. Non-float pages aren't pages
...
are tolerated but aren't recommended.
...
exists. It could be paraphrased by: \emph{declare the layer only, if it hasn't
...
unchanged and won't be reset to the initial default state. Using either
...
use \Macro{ForEachLayerOfPageStyle} internally. So these also won't process
