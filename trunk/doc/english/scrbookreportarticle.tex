...
\ProvidesFile{scrbookreportarticle.tex}[2005/12/13 KOMA-Script guide (chapter:
...
\Package{caption2}\IndexPackage{caption2} (see \cite{package:caption2}) has
...
\begin{Explain}
  ...
  \Package{caption2}\IndexPackage{caption2} (see \cite{package:caption2}) is
