...
\begin{description}
\item[empty\BeginIndex{Pagestyle}{empty}\PageStyleLabel{empty}] is the page
  style with entirely empty headers and footers. In {\KOMAScript} this is
  completely identical to the standard classes.
\item[headings\BeginIndex{Pagestyle}{headings}\PageStyleLabel{headings}] is
  ...
  described above.
\item[myheadings\BeginIndex{Pagestyle}{myheadings}\PageStyleLabel{myheadings}]
  ...
  below).
\item[plain\BeginIndex{Pagestyle}{plain}\PageStyleLabel{plain}] is the page
