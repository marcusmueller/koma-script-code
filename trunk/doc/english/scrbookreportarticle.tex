...
% Date of translated german file: 2015-02-23
...
longer. Nevertheless, if a compatibility level prior to 3.17 (see option \Option{version}, \autoref{sec:maincls.compatibilityOptions},
\autopageref{desc:maincls.option.version}) has been selected, commands
\Macro{sectionformat} down to \Macro{subparagraphformat} become unused by
...
\begin{lstcode}
  ...
  \newcommand*{\sectionformat}{%
    \csname thesection\endcsname\autodot\endskip
  }%
