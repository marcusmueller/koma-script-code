...
\ProvidesFile{scrbookreportarticle.tex}[2012/02/01 KOMA-Script guide (chapter:
...
But before describing the classes, I want to give you some additional
suggestions. Starting a new document you will often doubt which settings are
the best. Some settings like the paper format may be specified. But even the
question of the size of the text area and the margins could be a hard
decision. On the other side, the main business of an author\,---\,planning the
document structure, writing the text, finding or creating figures, tables,
lists and data\,---\,should be almost independent of those settings. After
finishing this main part of work it's early enough to find the best
design. Beside selection of options things like correction of hyphenation and
tiny changes of page breaks or placement of figures and tables should be part
of this document finishing.
...
\section{Selection of the Document Font Size\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.fontOptions}

\mbox{}

\section{Text Markup\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.textmarkup}

\mbox{}

\section{Document Title Pages\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.titlepage}

\mbox{}

\section{Abstract\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.abstract}

\mbox{}

\section{Table of Contents\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.toc}

\mbox{}

\section{Paragraph Markup\protect\footnote{This section is
    still missing. Translators from German to English would be welcome!}}
\label{sec:maincls.parmarkup}
...
\section{The Table of Contents\protect\footnote{This section is deprecated
    and should be replaced by new sections using the structure of the German
    guide. Translators from English to German would be welcome! You may find
    additional information about obsolete or deprecated options at
    \autoref{cha:maincls-experts}.}}
\label{sec:maincls.toc.obsolete}
