...
% Date of the translated German file: 2014/03/12
...
\end{lstcode}
  ...
  avoided by adding before the last line of the code above:
\begin{lstcode}
  \DefineFamilyKey{butcher}%
                  {coldcut}[true]{}%
\end{lstcode}
...
\end{lstcode}
  With this, the option will be defined while
  ...
  option another definition is used, that will call the option again while
