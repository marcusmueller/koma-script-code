...
executed if the command is defined, otherwise the \PName{else
  instructions}. There is not a corresponding internal command.
%
...
otherwise the \PName{else instructions}. There is not a corresponding internal
command.
%
\EndIndex{Cmd}{ifstr}%
...
\PName{then instructions} will be executed, otherwise the \PName{else
  instructions}. The command is not completely expandable and there is not a
...
only. Otherwise the \PName{else instructions} will be used. There is not a
corresponding internal command.
%
