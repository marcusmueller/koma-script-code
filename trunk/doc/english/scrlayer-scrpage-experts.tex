...
aren't recommended any longer, package \Package{scrlayer-scrpage} provides
...
using one of the previously described features. So less advanced users don't
...
\PName{name} doesn't already exist, and therefor may be used to redefine an
existing page style.
...
%
\begin{Example}
  Assumed, you want to background the whole head of page style
...
mode always. In opposite to this \Package{scrlayer-scrpage} doesn't switch
