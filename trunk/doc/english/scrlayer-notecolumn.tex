...
change the font attributes using \DescRef{\LabelBase.cmd.setkomafont} and \DescRef{\LabelBase.cmd.addtokomafont}
...
\Macro{clearnotecolumns} without any optional argument.
