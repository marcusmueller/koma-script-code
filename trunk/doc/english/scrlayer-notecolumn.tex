...
\translator{Markus Kohm\and Mr.~Schubert}
...
switches are irrelevant when the user makes a note but relevant when the
...
\begin{Example}
  ...
  main text in the main column. The sections should be put into a smaller note
  column on the right side of the main column using a smaller font\iffree{
