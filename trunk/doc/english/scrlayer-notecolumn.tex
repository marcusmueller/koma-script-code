...
% Date of the translated German file: 2019-03-02
...
% TODO: Fix my translation changes
...
auxiliary file. This inevitably would lead to errors in processing and
output. To attenuate this risk, the \Macro{catcodes} of the characters from
\Macro{dospecials}\IndexCmd{dospecials} are stored while
\Macro{begin}\PParameter{document} and explicitly restored while reading from
the auxiliary file.%
% :ODOT
\EndIndexGroup
