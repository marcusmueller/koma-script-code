...
\lalias{desc:scrlttr2.cmd.item.description}{desc:maincls.cmd.item.description}
\lalias{desc:scrlttr2.cmd.item.labeling}{desc:maincls.cmd.item.labeling}
