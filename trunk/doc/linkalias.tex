...
\newcommand*{\lalias}[3][]{%
  \scr@ifundefinedorrelax{r@#2}{%
    \IfArgIsEmpty{#1}{%
      \expandafter\let\csname r@#2\expandafter\endcsname\csname r@#3\endcsname
    }{%
      \expandafter\let\expandafter\reserved@a\csname r@#3\endcsname
      \expandafter\expandafter\expandafter\def\expandafter\expandafter\expandafter\reserved@a\expandafter\expandafter\expandafter{\expandafter\@gobble\reserved@a}%
...
\lalias[\OptionValue{parskip}{relative}]{desc:maincls-experts.option.parskip.relative}{desc:maincls.option.parskip=Methode}
