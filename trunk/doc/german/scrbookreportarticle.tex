...
\ProvidesFile{scrbookreportarticle.tex}[2005/05/17 KOMA-Script guide (chapter:
...
\autopageref{desc:typearea.options.papersize}). Dabei entsprechen die Optionen
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.twoside}%
  \Option{oneside}\\
  \Option{twoside}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.cleardouble}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.titlepage}%
  \Option{titlepage}\\
  \Option{notitlepage}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.headsepline}%
  \Option{headsepline}\\
  \Option{headnosepline}\\
  \Option{footsepline}\\
  \Option{footnosepline}
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.chapterprefix}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.appendixprefix}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.noonelinecaption}%
  \Option{onelinecaption}\\
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.smallheadings}%
...
Option \Option{bigheadings} sehr groß eingestellen Überschriften die beiden
Optionen \Option{normalheadings} und \Option{smallheadings} zur Ver"-fügung,
mit denen man insgesamt kleinere Überschriften erhält.
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.liststotoc}%
  \Option{liststotoc}\\
  \Option{idxtotoc}\\
  \Option{bibtotoc}\\
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.tocleft}%
  \Option{tocindent}\\
  \Option{tocleft}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.listsleft}%
  \Option{listsindent}\\
  \Option{listsleft}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.abstracton}%
  \Option{abstracton}\\
  \Option{abstractoff}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.dotlessnumbers}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.tablecaptionabove}%
  \Option{tablecaptionbelow}\\
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.option.origlongtable}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.titlepagestyle}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.clearpage}%
  \Macro{clearpage}\\
...
dass alle noch nicht ausgegebenen Fließumgebungen ausgegeben werden und
...
\autoref{sec:maincls.layoutOptions},
\autopageref{desc:maincls.option.cleardouble} erklärten Layoutoptionen
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.ifthispageodd}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.pagenumbering}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.title}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.environment.abstract}%
...
\autoref{sec:maincls.structure}, \autopageref{desc:maincls.macro.chapterstar}
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.counter.tocdepth}%
  \Counter{tocdepth}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.chapterstar}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.raggedsection}%
  \Macro{raggedsection}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.partformat}%
  \Macro{partformat}\\
  \Macro{chapterformat}\\
...
\autopageref{desc:maincls.option.dotlessnumbers} erläutert wurde, müssen gemäß
...
\end{lstlisting}
  ...
  \autoref{sec:maincls.formattingOptions},
  \autopageref{desc:maincls.option.dotlessnumbers}.
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.chaptermark}%
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.dictum}%
...
\begin{Declaration}
  ...
  \phantomsection\label{desc:maincls.macro.textsuperscript}%
...
\begin{Explain}
  {\LaTeX} bietet mit den Fließumgebungen einen sehr leistungsfähigen und
...
\begin{Declaration}
  \phantomsection\label{desc:maincls.macro.caption}%
...
\begin{Explain}
\begin{Declaration}
  \phantomsection\label{desc:maincls.floatstyle.komaabove}%
  \PValue{komaabove}\\
  \PValue{komabelow}
\end{Declaration}%
...
\autoref{sec:maincls.formattingOptions},
\autopageref{desc:maincls.option.dotlessnumbers} näher erläutert.
