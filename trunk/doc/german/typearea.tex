...
\begin{Declaration}
  \phantomsection\label{desc:typearea.option.BCOR}%
...
\begin{Declaration}
  \phantomsection\label{desc:typearea.option.DIVcalc}%
  \Option{DIVcalc}\\
  \Option{DIVclassic}
\end{Declaration}%
...
\begin{Declaration}
  \phantomsection\label{desc:typearea.macro.typearea}%
...
\begin{Declaration}
  \phantomsection\label{desc:typearea.option.headinclude}%
  \Option{headinclude}\\
  \Option{headexclude}\\
  \Option{footinclude}\\
  \Option{footexclude}
...
\begin{Declaration}
  \phantomsection\label{desc:typearea.option.headlines}%
...
\begin{Declaration}
  \phantomsection\label{desc:typearea.options.papersize}%
  \Option{letterpaper} \\
  \Option{legalpaper} \\
