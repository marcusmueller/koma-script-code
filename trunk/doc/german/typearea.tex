...
Wert \PValue{semi} angegeben werden. Für \Package{typearea} entspricht dieser
Wert \PValue{false}. Gleichzeitig wird jedoch der \LaTeX-Schalter für
doppelseitiges Layout gesetzt. Im Resultat gehen \LaTeX{} selbst und die
meisten Klassen damit von doppelseitigem Layout aus. Dies ist beispielsweise
dann interessant, wenn man bei einseitigem Druck im Kopf oder Fuß zwischen
geraden und ungeraden Seiten unterscheiden will. Für die Marginalien wird in
diesem Fall jedoch nicht zwischen geraden und ungeraden Seiten unterschieden.
