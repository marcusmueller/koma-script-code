...
% ======================================================================
%
\ProvidesFile{guide-ngerman.tex}[{2005/05/13 
...
\newcommand*{\GuideCopyright}{Freie Version ohne Optimierung des
  Umbruchs\par\medskip%
  Diese Anleitung ist als Bestandteil von \KOMAScript{} frei im Sinne der
  \LaTeX{} Project Public License Version 1.0.  Eine für \KOMAScript{} gültige
  deutsche Übersetzung liegt \KOMAScript{} in der Datei »\texttt{LEGALDE.TXT}«
  ...
  erschienen.}%
\newcommand*{\GuideDedication}{Für all jene, denen gute Typografie noch etwas
  bedeutet.}%
%    \end{macrocode}
% \end{macro}
% \end{macro}
