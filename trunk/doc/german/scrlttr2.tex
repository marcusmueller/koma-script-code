...
\ProvidesFile{scrlttr2.tex}[2007/11/28 KOMA-Script guide (chapter: scrlttr2)]
...
Diese\ChangedAt{v2.97e}{\Class{scrlttr2}} vier Pseudolängen bestimmen die Länge
der vier horizontalen Marken. Dabei gilt eine Besonderheit. Ist die Länge
nämlich mit Null angegeben, so werden bei den Pseudolängen
\PLength{tfoldmarklength}, \PLength{mfoldmarklength} und
\PLength{bfoldmarklength} für die drei in der vertikalen Position
konfigurierbaren Faltmarken stattdessen 2\,mm als Länge verwendet. Die Länge
der Lochermarke, \PLength{pfoldmarklength}, wird hingegen auf 4\,mm gesetzt.
...
Besonderheit, dass bei einer angegebenen Länge von Null, stattdessen 4\,mm
verwendet werden.
...
Faltmarken an. Voreingestellt sind 0,2\,pt, also eine sehr dünne
...
Rücksendeadresse kann über das Element \FontElement{backaddress} geändert
werden (siehe \autoref{sec:scrlttr2.font},
\autopageref{sec:scrlttr2.font}). Für das Element ist \Macro{sffamily}
voreingestellt, wobei zuvor noch auf \Macro{scriptsize} umgeschaltet wird.
%
