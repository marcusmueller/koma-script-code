...
aber \autopageref{sec:scrlttr2.font} angegeben sind. Voreingestellt ist keine
Änderung.
...
werden (siehe \autoref{sec:scrlttr2.font}, ab
\autopageref{sec:scrlttr2.font}). Für das Element ist \Macro{sffamily}
voreingestellt, wobei zuvor noch auf \Macro{scriptsize} umgeschaltet
wird.
%
